...
void                                    do_commune(struct char_data *ch, const char *argument,
						   int cmd);
void                                    do_tell(struct char_data *ch, const char *argument, int cmd);
void                                    do_whisper(struct char_data *ch, const char *argument,
						   int cmd);
void                                    do_ask(struct char_data *ch, const char *argument, int cmd);
void                                    do_write(struct char_data *ch, const char *argument, int cmd);

void                                    do_group_tell(struct char_data *ch, const char *argument,
						      int cmd);
void                                    do_group_report(struct char_data *ch, const char *argument,
							int cmd);
