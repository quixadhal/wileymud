...
void                                    do_group_tell(struct char_data *ch, char *arguement,
						      int cmd);
void                                    do_group_report(struct char_data *ch, char *arguement,
							int cmd);
void                                    do_split(struct char_data *ch, char *arguement,
						 int cmd);
