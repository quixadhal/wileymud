...
void                                    do_backstab(struct char_data *ch, const char *argument,
						    int cmd);
...
void                                    do_bandage(struct char_data *ch, const char *argument,
						   int cmd);
