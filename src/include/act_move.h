...
void                                    DisplayOneMove(struct char_data *ch, int dir,
						       int was_in);
void                                    DisplayGroupMove(struct char_data *ch, int dir,
							 int was_in, int total);
int                                     do_move(struct char_data *ch, char *argument, int cmd);
void                                    DisplayMove(struct char_data *ch, int dir, int was_in,
						    int total);
void                                    AddToCharHeap(struct char_data *heap[50], int *top,
