...
int                                     GainLevel(struct char_data *guildmaster,
						  struct char_data *ch, int class);
struct char_data                       *FindMobInRoomWithFunction(int room, ifuncp func);
int                                     MageGuildMaster(struct char_data *ch, int cmd,
							const char *arg);
int                                     ClericGuildMaster(struct char_data *ch, int cmd,
							  const char *arg);
int                                     ThiefGuildMaster(struct char_data *ch, int cmd,
							 const char *arg);
int                                     FighterGuildMaster(struct char_data *ch, int cmd,
							   const char *arg);
int                                     dump(struct char_data *ch, int cmd, const char *arg);
int                                     mayor(struct char_data *ch, int cmd, const char *arg);
struct char_data                       *find_mobile_here_with_spec_proc(ifuncp fcn,
									int rnumber);
void                                    exec_social(struct char_data *npc, const char *cmd,
...
int                                     PaladinGuildGuard(struct char_data *ch, int cmd,
							  const char *arg);
int                                     AbyssGateKeeper(struct char_data *ch, int cmd,
							const char *arg);
...
int                                     AbbarachDragon(struct char_data *ch, int cmd,
						       const char *arg);
...
void                                    zm_zap_spell_at(struct char_data *ch,
							struct char_data *vict, int maxlevel);
...
int                                     pray_for_items(struct char_data *ch, int cmd,
						       const char *arg);
#define CHAL_ACT \
...
int                                     delivery_beast(struct char_data *ch, int cmd,
						       const char *arg);
...
int                                     RangerGuildMaster(struct char_data *ch, int cmd,
							  const char *arg);
int                                     GenericGuildMaster(struct char_data *ch, int cmd,
							   const char *arg);
...
void                                    gm_wrong_class(struct char_data *master,
						       struct char_data *vict);
void                                    gm_wrong_alignment(struct char_data *master,
							   struct char_data *vict);
void                                    gm_gain(struct char_data *master,
						struct char_data *vict, int target);
void                                    gm_prac(struct char_data *master,
						struct char_data *vict, int target, const char *arg);
...
int                                     Tate_ThiefGuildMaster(struct char_data *ch, int cmd,
							      const char *arg);
