...
void                                    do_not_here(struct char_data *ch, char *argument,
						    int cmd);
...
void                                    do_compact(struct char_data *ch, char *argument,
						   int cmd);
...
void                                    do_plr_notell(struct char_data *ch, char *argument,
						      int cmd);
void                                    do_plr_nosummon(struct char_data *ch, char *argument,
							int cmd);
void                                    do_plr_noteleport(struct char_data *ch, char *argument,
							  int cmd);
