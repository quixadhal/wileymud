...
void dcprintf(struct descriptor_data *d, const char *Str, ...) __attribute__((format(printf, 2, 3)));
void cprintf(struct char_data *ch, const char *Str, ...) __attribute__((format(printf, 2, 3)));
void rprintf(int room, const char *Str, ...) __attribute__((format(printf, 2, 3)));
void zprintf(int zone, const char *Str, ...) __attribute__((format(printf, 2, 3)));
void allprintf(const char *Str, ...) __attribute__((format(printf, 1, 2)));
void oprintf(const char *Str, ...) __attribute__((format(printf, 1, 2)));
void eprintf(struct char_data *ch, const char *Str, ...) __attribute__((format(printf, 2, 3)));
void reprintf(int room, struct char_data *ch, const char *Str, ...) __attribute__((format(printf, 3, 4)));
void re2printf(int room, struct char_data *ch1, struct char_data *ch2, const char *Str, ...)
    __attribute__((format(printf, 4, 5)));
void iprintf(const char *Str, ...) __attribute__((format(printf, 1, 2)));
void save_all(void);
