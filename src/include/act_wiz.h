...
void                                    do_polymorph(struct char_data *ch, const char *argument,
						     int cmdnum);
void                                    do_highfive(struct char_data *ch, const char *argument,
						    int cmd);
void                                    do_rentmode(struct char_data *ch, const char *argument,
						    int cmd);
...
void                                    do_system(struct char_data *ch, const char *argument,
						  int cmd);
...
void                                    do_apraise(struct char_data *ch, const char *argument,
						   int cmd);
...
void                                    do_advance(struct char_data *ch, const char *argument,
						   int cmd);
void                                    do_reroll(struct char_data *ch, const char *argument,
						  int cmd);
void                                    do_restore_all(struct char_data *ch, const char *arg,
						       int cmd);
void                                    restore_one_victim(struct char_data *victim);
void                                    do_restore(struct char_data *ch, const char *argument,
						   int cmd);
void                                    do_show_logs(struct char_data *ch, const char *argument,
						     int cmd);
void                                    do_noshout(struct char_data *ch, const char *argument,
						   int cmd);
void                                    do_pager(struct char_data *ch, const char *arg, int cmd);
void                                    do_nohassle(struct char_data *ch, const char *argument,
						    int cmd);
void                                    do_stealth(struct char_data *ch, const char *argument,
						   int cmd);
...
void                                    do_zone_purge(struct char_data *ch, const char *argument,
						      int cmd);
