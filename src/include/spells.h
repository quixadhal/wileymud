...
struct spell_info_type
{
    ...
    void (*spell_pointer)(int level, struct char_data *ch, const char *arg, int type, struct char_data *tar_ch,
...
void cast_armor(int level, struct char_data *ch, const char *arg, int type, struct char_data *tar_ch,
                struct obj_data *tar_obj);

#define SPELL_TELEPORT 2
void spell_teleport(int level, struct char_data *ch, struct char_data *victim, struct obj_data *obj);
void cast_teleport(int level, struct char_data *ch, const char *arg, int type, struct char_data *tar_ch,
                   struct obj_data *tar_obj);

#define SPELL_BLESS 3
void spell_bless(int level, struct char_data *ch, struct char_data *victim, struct obj_data *obj);
void cast_bless(int level, struct char_data *ch, const char *arg, int type, struct char_data *tar_ch,
                struct obj_data *tar_obj);

#define SPELL_BLINDNESS 4
void spell_blindness(int level, struct char_data *ch, struct char_data *victim, struct obj_data *obj);
void cast_blindness(int level, struct char_data *ch, const char *arg, int type, struct char_data *tar_ch,
                    struct obj_data *tar_obj);
...
void cast_burning_hands(int level, struct char_data *ch, const char *arg, int type, struct char_data *victim,
                        struct obj_data *tar_obj);
...
void cast_call_lightning(int level, struct char_data *ch, const char *arg, int type, struct char_data *victim,
                         struct obj_data *tar_obj);
...
void cast_charm_person(int level, struct char_data *ch, const char *arg, int type, struct char_data *tar_ch,
                       struct obj_data *tar_obj);
...
void cast_chill_touch(int level, struct char_data *ch, const char *arg, int type, struct char_data *victim,
                      struct obj_data *tar_obj);

#define SPELL_CLONE 9
void spell_clone(int level, struct char_data *ch, struct char_data *victim, struct obj_data *obj);
void cast_clone(int level, struct char_data *ch, const char *arg, int type, struct char_data *tar_ch,
                struct obj_data *tar_obj);
...
void cast_color_spray(int level, struct char_data *ch, const char *arg, int type, struct char_data *victim,
                      struct obj_data *tar_obj);
...
void cast_control_weather(int level, struct char_data *ch, const char *arg, int type, struct char_data *tar_ch,
                          struct obj_data *tar_obj);
...
void cast_create_food(int level, struct char_data *ch, const char *arg, int type, struct char_data *tar_ch,
                      struct obj_data *tar_obj);
...
void cast_create_water(int level, struct char_data *ch, const char *arg, int type, struct char_data *tar_ch,
                       struct obj_data *tar_obj);
...
void cast_cure_blind(int level, struct char_data *ch, const char *arg, int type, struct char_data *tar_ch,
                     struct obj_data *tar_obj);
...
void cast_cure_critic(int level, struct char_data *ch, const char *arg, int type, struct char_data *tar_ch,
                      struct obj_data *tar_obj);
...
void cast_cure_light(int level, struct char_data *ch, const char *arg, int type, struct char_data *tar_ch,
                     struct obj_data *tar_obj);

#define SPELL_CURSE 17
void spell_curse(int level, struct char_data *ch, struct char_data *victim, struct obj_data *obj);
void cast_curse(int level, struct char_data *ch, const char *arg, int type, struct char_data *tar_ch,
                struct obj_data *tar_obj);
...
void cast_detect_evil(int level, struct char_data *ch, const char *arg, int type, struct char_data *tar_ch,
                      struct obj_data *tar_obj);
...
void cast_detect_invisibility(int level, struct char_data *ch, const char *arg, int type, struct char_data *tar_ch,
                              struct obj_data *tar_obj);
...
void cast_detect_magic(int level, struct char_data *ch, const char *arg, int type, struct char_data *tar_ch,
                       struct obj_data *tar_obj);
...
void cast_detect_poison(int level, struct char_data *ch, const char *arg, int type, struct char_data *tar_ch,
                        struct obj_data *tar_obj);
...
void cast_dispel_evil(int level, struct char_data *ch, const char *arg, int type, struct char_data *tar_ch,
                      struct obj_data *tar_obj);
...
void cast_earthquake(int level, struct char_data *ch, const char *arg, int type, struct char_data *victim,
                     struct obj_data *tar_obj);
void spell_new_earthquake(int level, struct char_data *ch, struct char_data *victim, struct obj_data *obj);
void cast_new_earthquake(int level, struct char_data *ch, const char *arg, int type, struct char_data *victim,
                         struct obj_data *tar_obj);
...
void cast_enchant_weapon(int level, struct char_data *ch, const char *arg, int type, struct char_data *tar_ch,
                         struct obj_data *tar_obj);
void cast_enchant_armor(int level, struct char_data *ch, const char *arg, int type, struct char_data *tar_ch,
                        struct obj_data *tar_obj);
...
void cast_energy_drain(int level, struct char_data *ch, const char *arg, int type, struct char_data *victim,
                       struct obj_data *tar_obj);

#define SPELL_FIREBALL 26
void spell_fireball(int level, struct char_data *ch, struct char_data *victim, struct obj_data *obj);
void cast_fireball(int level, struct char_data *ch, const char *arg, int type, struct char_data *victim,
                   struct obj_data *tar_obj);

#define SPELL_HARM 27
void spell_harm(int level, struct char_data *ch, struct char_data *victim, struct obj_data *obj);
void cast_harm(int level, struct char_data *ch, const char *arg, int type, struct char_data *victim,
               struct obj_data *tar_obj);

#define SPELL_HEAL 28
void spell_heal(int level, struct char_data *ch, struct char_data *victim, struct obj_data *obj);
void cast_heal(int level, struct char_data *ch, const char *arg, int type, struct char_data *tar_ch,
               struct obj_data *tar_obj);
...
void cast_invisibility(int level, struct char_data *ch, const char *arg, int type, struct char_data *tar_ch,
                       struct obj_data *tar_obj);
...
void cast_lightning_bolt(int level, struct char_data *ch, const char *arg, int type, struct char_data *victim,
                         struct obj_data *tar_obj);

#define SPELL_LOCATE_OBJECT 31
void spell_locate_object(int level, struct char_data *ch, struct char_data *victim, char *obj);
void cast_locate_object(int level, struct char_data *ch, const char *arg, int type, struct char_data *tar_ch,
                        struct obj_data *tar_obj);
...
void cast_magic_missile(int level, struct char_data *ch, const char *arg, int type, struct char_data *victim,
                        struct obj_data *tar_obj);

#define SPELL_POISON 33
void spell_poison(int level, struct char_data *ch, struct char_data *victim, struct obj_data *obj);
void cast_poison(int level, struct char_data *ch, const char *arg, int type, struct char_data *tar_ch,
                 struct obj_data *tar_obj);
...
void cast_protection_from_evil(int level, struct char_data *ch, const char *arg, int type, struct char_data *tar_ch,
                               struct obj_data *tar_obj);
...
void cast_remove_curse(int level, struct char_data *ch, const char *arg, int type, struct char_data *tar_ch,
                       struct obj_data *tar_obj);

#define SPELL_SANCTUARY 36
void spell_sanctuary(int level, struct char_data *ch, struct char_data *victim, struct obj_data *obj);
void cast_sanctuary(int level, struct char_data *ch, const char *arg, int type, struct char_data *tar_ch,
                    struct obj_data *tar_obj);
...
void cast_shocking_grasp(int level, struct char_data *ch, const char *arg, int type, struct char_data *victim,
                         struct obj_data *tar_obj);

#define SPELL_SLEEP 38
void spell_sleep(int level, struct char_data *ch, struct char_data *victim, struct obj_data *obj);
void cast_sleep(int level, struct char_data *ch, const char *arg, int type, struct char_data *tar_ch,
                struct obj_data *tar_obj);

#define SPELL_STRENGTH 39
void spell_strength(int level, struct char_data *ch, struct char_data *victim, struct obj_data *obj);
void cast_strength(int level, struct char_data *ch, const char *arg, int type, struct char_data *tar_ch,
                   struct obj_data *tar_obj);

#define SPELL_SUMMON 40
void spell_summon(int level, struct char_data *ch, struct char_data *victim, struct obj_data *obj);
void cast_summon(int level, struct char_data *ch, const char *arg, int type, struct char_data *tar_ch,
                 struct obj_data *tar_obj);
...
void cast_ventriloquate(int level, struct char_data *ch, const char *arg, int type, struct char_data *tar_ch,
                        struct obj_data *tar_obj);
...
void cast_word_of_recall(int level, struct char_data *ch, const char *arg, int type, struct char_data *tar_ch,
                         struct obj_data *tar_obj);
...
void cast_remove_poison(int level, struct char_data *ch, const char *arg, int type, struct char_data *tar_ch,
                        struct obj_data *tar_obj);
...
void cast_sense_life(int level, struct char_data *ch, const char *arg, int type, struct char_data *tar_ch,
                     struct obj_data *tar_obj);
...
void cast_identify(int level, struct char_data *ch, const char *arg, int type, struct char_data *tar_ch,
                   struct obj_data *tar_obj);
...
void cast_infravision(int level, struct char_data *ch, const char *arg, int type, struct char_data *tar_ch,
                      struct obj_data *tar_obj);
...
void cast_cause_light(int level, struct char_data *ch, const char *arg, int type, struct char_data *victim,
                      struct obj_data *tar_obj);
...
void cast_cause_critic(int level, struct char_data *ch, const char *arg, int type, struct char_data *victim,
                       struct obj_data *tar_obj);
...
void cast_flamestrike(int level, struct char_data *ch, const char *arg, int type, struct char_data *victim,
                      struct obj_data *tar_obj);
...
void cast_dispel_good(int level, struct char_data *ch, const char *arg, int type, struct char_data *tar_ch,
                      struct obj_data *tar_obj);

#define SPELL_WEAKNESS 59
void spell_weakness(int level, struct char_data *ch, struct char_data *victim, struct obj_data *obj);
void cast_weakness(int level, struct char_data *ch, const char *arg, int type, struct char_data *tar_ch,
                   struct obj_data *tar_obj);
...
void cast_dispel_magic(int level, struct char_data *ch, const char *arg, int type, struct char_data *tar_ch,
                       struct obj_data *tar_obj);

#define SPELL_KNOCK 61
void cast_knock(int level, struct char_data *ch, const char *arg, int type, struct char_data *tar_ch,
                struct obj_data *tar_obj);
...
void cast_know_alignment(int level, struct char_data *ch, const char *arg, int type, struct char_data *tar_ch,
                         struct obj_data *tar_obj);
...
void cast_animate_dead(int level, struct char_data *ch, const char *arg, int type, struct char_data *tar_ch,
                       struct obj_data *tar_obj);

#define SPELL_PARALYSIS 64
void spell_paralyze(int level, struct char_data *ch, struct char_data *victim, struct obj_data *obj);
void cast_paralyze(int level, struct char_data *ch, const char *arg, int type, struct char_data *tar_ch,
                   struct obj_data *tar_obj);
...
void cast_remove_paralysis(int level, struct char_data *ch, const char *arg, int type, struct char_data *tar_ch,
                           struct obj_data *tar_obj);

#define SPELL_FEAR 66
void spell_fear(int level, struct char_data *ch, struct char_data *victim, struct obj_data *obj);
void cast_fear(int level, struct char_data *ch, const char *arg, int type, struct char_data *tar_ch,
               struct obj_data *tar_obj);
...
void cast_acid_blast(int level, struct char_data *ch, const char *arg, int type, struct char_data *victim,
                     struct obj_data *tar_obj);
...
void cast_water_breath(int level, struct char_data *ch, const char *arg, int type, struct char_data *tar_ch,
                       struct obj_data *tar_obj);

#define SPELL_FLY 69
void spell_fly(int level, struct char_data *ch, struct char_data *victim, struct obj_data *obj);
void cast_flying(int level, struct char_data *ch, const char *arg, int type, struct char_data *tar_ch,
                 struct obj_data *tar_obj);
...
void cast_cone_of_cold(int level, struct char_data *ch, const char *arg, int type, struct char_data *victim,
                       struct obj_data *tar_obj);
...
void cast_meteor_swarm(int level, struct char_data *ch, const char *arg, int type, struct char_data *victim,
                       struct obj_data *tar_obj);

#define SPELL_ICE_STORM 72
void spell_ice_storm(int level, struct char_data *ch, struct char_data *victim, struct obj_data *obj);
void cast_ice_storm(int level, struct char_data *ch, const char *arg, int type, struct char_data *victim,
                    struct obj_data *tar_obj);

#define SPELL_SHIELD 73
void spell_shield(int level, struct char_data *ch, struct char_data *victim, struct obj_data *obj);
void cast_shield(int level, struct char_data *ch, const char *arg, int type, struct char_data *tar_ch,
                 struct obj_data *tar_obj);
...
void cast_mon_sum1(int level, struct char_data *ch, const char *arg, int type, struct char_data *tar_ch,
                   struct obj_data *tar_obj);

#define SPELL_MON_SUM_2 75
void cast_mon_sum2(int level, struct char_data *ch, const char *arg, int type, struct char_data *tar_ch,
                   struct obj_data *tar_obj);

#define SPELL_MON_SUM_3 76
void cast_mon_sum3(int level, struct char_data *ch, const char *arg, int type, struct char_data *tar_ch,
                   struct obj_data *tar_obj);

#define SPELL_MON_SUM_4 77
void cast_mon_sum4(int level, struct char_data *ch, const char *arg, int type, struct char_data *tar_ch,
                   struct obj_data *tar_obj);

#define SPELL_MON_SUM_5 78
void cast_mon_sum5(int level, struct char_data *ch, const char *arg, int type, struct char_data *tar_ch,
                   struct obj_data *tar_obj);

#define SPELL_MON_SUM_6 79
void cast_mon_sum6(int level, struct char_data *ch, const char *arg, int type, struct char_data *tar_ch,
                   struct obj_data *tar_obj);

#define SPELL_MON_SUM_7 80
void cast_mon_sum7(int level, struct char_data *ch, const char *arg, int type, struct char_data *tar_ch,
                   struct obj_data *tar_obj);
...
void cast_fireshield(int level, struct char_data *ch, const char *arg, int type, struct char_data *tar_ch,
                     struct obj_data *tar_obj);
...
void cast_charm_monster(int level, struct char_data *ch, const char *arg, int type, struct char_data *tar_ch,
                        struct obj_data *tar_obj);
...
void cast_cure_serious(int level, struct char_data *ch, const char *arg, int type, struct char_data *tar_ch,
                       struct obj_data *tar_obj);
...
void cast_cause_serious(int level, struct char_data *ch, const char *arg, int type, struct char_data *victim,
                        struct obj_data *tar_obj);

#define SPELL_REFRESH 85
void spell_refresh(int level, struct char_data *ch, struct char_data *victim, struct obj_data *obj);
void cast_refresh(int level, struct char_data *ch, const char *arg, int type, struct char_data *tar_ch,
                  struct obj_data *tar_obj);
...
void cast_second_wind(int level, struct char_data *ch, const char *arg, int type, struct char_data *tar_ch,
                      struct obj_data *tar_obj);

#define SPELL_TURN 87
void spell_turn(int level, struct char_data *ch, struct char_data *victim, struct obj_data *obj);
void cast_turn(int level, struct char_data *ch, const char *arg, int type, struct char_data *tar_ch,
               struct obj_data *tar_obj);

#define SPELL_SUCCOR 88
void spell_succor(int level, struct char_data *ch, struct char_data *victim, struct obj_data *obj);
void cast_succor(int level, struct char_data *ch, const char *arg, int type, struct char_data *tar_ch,
                 struct obj_data *tar_obj);

#define SPELL_LIGHT 89
void spell_light(int level, struct char_data *ch, struct char_data *victim, struct obj_data *obj);
void cast_light(int level, struct char_data *ch, const char *arg, int type, struct char_data *tar_ch,
                struct obj_data *tar_obj);
...
void cast_cont_light(int level, struct char_data *ch, const char *arg, int type, struct char_data *tar_ch,
                     struct obj_data *tar_obj);

#define SPELL_CALM 91
void spell_calm(int level, struct char_data *ch, struct char_data *victim, struct obj_data *obj);
void cast_calm(int level, struct char_data *ch, const char *arg, int type, struct char_data *tar_ch,
               struct obj_data *tar_obj);
...
void cast_stone_skin(int level, struct char_data *ch, const char *arg, int type, struct char_data *tar_ch,
                     struct obj_data *tar_obj);
...
void cast_conjure_elemental(int level, struct char_data *ch, const char *arg, int type, struct char_data *tar_ch,
                            struct obj_data *tar_obj);
...
void cast_true_seeing(int level, struct char_data *ch, const char *arg, int type, struct char_data *tar_ch,
                      struct obj_data *tar_obj);
...
void cast_minor_creation(int level, struct char_data *ch, const char *arg, int type, struct char_data *tar_ch,
                         struct obj_data *tar_obj);
...
void cast_faerie_fire(int level, struct char_data *ch, const char *arg, int type, struct char_data *tar_ch,
                      struct obj_data *tar_obj);
...
void cast_faerie_fog(int level, struct char_data *ch, const char *arg, int type, struct char_data *victim,
                     struct obj_data *tar_obj);
...
void cast_cacaodemon(int level, struct char_data *ch, const char *arg, int type, struct char_data *tar_ch,
                     struct obj_data *tar_obj);

#define SPELL_POLY_SELF 99
void spell_poly_self(int level, struct char_data *ch, struct char_data *mob, struct obj_data *obj);
void cast_poly_self(int level, struct char_data *ch, const char *arg, int type, struct char_data *tar_ch,
                    struct obj_data *tar_obj);

#define SPELL_MANA 100
void spell_mana(int level, struct char_data *ch, struct char_data *victim, struct obj_data *obj);
void cast_mana(int level, struct char_data *ch, const char *arg, int type, struct char_data *tar_ch,
               struct obj_data *tar_obj);
...
void cast_astral_walk(int level, struct char_data *ch, const char *arg, int type, struct char_data *tar_ch,
                      struct obj_data *tar_obj);

#define SPELL_FLY_GROUP 102
void spell_fly_group(int level, struct char_data *ch, struct char_data *victim, struct obj_data *obj);
void cast_fly_group(int level, struct char_data *ch, const char *arg, int type, struct char_data *tar_ch,
                    struct obj_data *tar_obj);

#define SPELL_AID 103
void spell_aid(int level, struct char_data *ch, struct char_data *victim, struct obj_data *obj);
void cast_aid(int level, struct char_data *ch, const char *arg, int type, struct char_data *tar_ch,
              struct obj_data *tar_obj);

#define SPELL_SHELTER 104
void spell_shelter(int level, struct char_data *ch, struct char_data *victim, struct obj_data *obj);
void cast_shelter(int level, struct char_data *ch, const char *arg, int type, struct char_data *tar_ch,
                  struct obj_data *tar_obj);

#define SPELL_DRAGON_BREATH 105
void cast_dragon_breath(int level, struct char_data *ch, const char *arg, int type, struct char_data *tar_ch,
...
void cast_goodberry(int level, struct char_data *ch, const char *arg, int type, struct char_data *tar_ch,
                    struct obj_data *tar_obj);

#define SPELL_VISIONS 107
void spell_visions(int level, struct char_data *ch, struct char_data *victim, struct obj_data *obj);
void cast_visions(int level, struct char_data *ch, const char *arg, int type, struct char_data *tar_ch,
                  struct obj_data *tar_obj);
...
void cast_resurrection(int level, struct char_data *ch, const char *arg, int type, struct char_data *tar_ch,
                       struct obj_data *tar_obj);
...
void cast_green_slime(int level, struct char_data *ch, const char *arg, int type, struct char_data *victim,
                      struct obj_data *tar_obj);

#define SPELL_GEYSER 200
void spell_geyser(int level, struct char_data *ch, struct char_data *victim, struct obj_data *obj);
void cast_geyser(int level, struct char_data *ch, const char *arg, int type, struct char_data *victim,
                 struct obj_data *tar_obj);
...
void cast_fire_breath(int level, struct char_data *ch, const char *arg, int type, struct char_data *tar_ch,
                      struct obj_data *tar_obj);
...
void cast_gas_breath(int level, struct char_data *ch, const char *arg, int type, struct char_data *tar_ch,
                     struct obj_data *tar_obj);
...
void cast_frost_breath(int level, struct char_data *ch, const char *arg, int type, struct char_data *tar_ch,
                       struct obj_data *tar_obj);
...
void cast_acid_breath(int level, struct char_data *ch, const char *arg, int type, struct char_data *tar_ch,
                      struct obj_data *tar_obj);
...
void cast_lightning_breath(int level, struct char_data *ch, const char *arg, int type, struct char_data *tar_ch,
                           struct obj_data *tar_obj);
