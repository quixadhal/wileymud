...
void 
NotLegalMove(struct char_data *ch)
{
  if (DEBUG)
    dlog("NotLegalMove");
...
int 
check_exit_alias(struct char_data *ch, char *argument)
{
...
int 
ValidMove(struct char_data *ch, int cmd)
{
  char                             tmp[256];
  struct room_direction_data      *exitp;
  struct room_data                *here,
                                  *there;
...
int 
RawMove(struct char_data *ch, int dir)
{
  int                              need_movement;
  struct obj_data                 *obj;
  bool                             has_boat;
...
int 
MoveOne(struct char_data *ch, int dir)
{
  int                              was_in;
...
int 
MoveGroup(struct char_data *ch, int dir)
{
...
int 
DisplayOneMove(struct char_data *ch, int dir, int was_in)
{
  if (DEBUG)
    dlog("DisplayOneMove");
...
int 
DisplayGroupMove(struct char_data *ch, int dir, int was_in, int total)
{
  if (DEBUG)
...
int 
DisplayMove(struct char_data *ch, int dir, int was_in, int total)
{
...
int 
AddToCharHeap(struct char_data *heap[50], int *top, int total[50],
	      struct char_data *k)
{
  int                              found,
                                   i;
...
void 
raw_unlock_door(struct char_data *ch, struct room_direction_data *exitp, int door)
{
  struct room_data                *rp;
  struct room_direction_data      *back;
  char                             buf[128];
...
void 
raw_lock_door(struct char_data *ch, struct room_direction_data *exitp, int door)
{
  struct room_data                *rp;
  struct room_direction_data      *back;
  char                             buf[128];
