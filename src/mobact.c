...
void 
mobile_guardian(struct char_data *ch)
{
  if (ch->in_room > -1) {
...
void 
mobile_wander(struct char_data *ch)
{
  int                              door;
...
void 
MobScavenge(struct char_data *ch)
{
...
int 
SameRace(struct char_data *ch1, struct char_data *ch2)
{
...
int 
AssistFriend(struct char_data *ch)
{
  struct char_data                *damsel,
                                  *targ,
                                  *tmp_ch;
