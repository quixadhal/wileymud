...
char                            *
ClassTitles(struct char_data *ch)
{
  int                              i,
                                   count = 0;
  static char                      buf[256];
...
graf(int age, int p0, int p1, int p2, int p3, int p4, int p5, int p6)
{
  ...
  if (age < 15)
    ...
    return (int)(p1 + (((age - 15) * (p2 - p1)) / 15));		/*
								 * 15..29 
								 */
  else if (age <= 44)
    return (int)(p2 + (((age - 30) * (p3 - p2)) / 15));		/*
								 * 30..44 
								 */
  else if (age <= 59)
    return (int)(p3 + (((age - 45) * (p4 - p3)) / 15));		/*
								 * 45..59 
								 */
  else if (age <= 79)
    return (int)(p4 + (((age - 60) * (p5 - p4)) / 20));		/*
								 * 60..79 
								 */
  else
    return (p6);		/*
 ...
 */
void 
advance_level(struct char_data *ch, int class)
{
  int                              add_hp,
                                   i;
...
void 
drop_level(struct char_data *ch, int class)
{
  int                              add_hp,
                                   lin_class;
...
void 
gain_exp_regardless(struct char_data *ch, int gain, int class)
{
  int                              i;
  bool                             is_altered = FALSE;
...
int 
ObjFromCorpse(struct obj_data *c)
{
  struct obj_data                 *jj,
                                  *next_thing;
