...
typedef enum
{
    ...
    SMAUG_ROOM_SOLITARY,
    SMAUG_ROOM_PET_SHOP,
    SMAUG_ROOM_NO_RECALL,
    SMAUG_ROOM_DONATION,
    SMAUG_ROOM_NODROPALL,
    SMAUG_ROOM_SILENCE,
    SMAUG_ROOM_LOGSPEECH,
    SMAUG_ROOM_NODROP,
    SMAUG_ROOM_CLANSTOREROOM,
    SMAUG_ROOM_NO_SUMMON,
    SMAUG_ROOM_NO_ASTRAL,
    SMAUG_ROOM_TELEPORT,
    SMAUG_ROOM_TELESHOWDESC,
    SMAUG_ROOM_NOFLOOR,
    SMAUG_ROOM_NOSUPPLICATE,
    SMAUG_ROOM_ARENA,
    SMAUG_ROOM_NOMISSILE,
    SMAUG_ROOM_R4,
    SMAUG_ROOM_R5,
    SMAUG_ROOM_PROTOTYPE,
    SMAUG_ROOM_DND,
    SMAUG_ROOM_BFS_MARK,
    SMAUG_ROOM_MAX
} smaug_room_flags;
...
typedef enum
{
    ...
    SMAUG_ITEM_LOOTABLE,
    SMAUG_ITEM_PERSONAL,
    SMAUG_ITEM_MULTI_INVOKE,
    SMAUG_ITEM_ENCHANTED,
    SMAUG_ITEM_FLAG_MAX
