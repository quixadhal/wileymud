...
const char *wear_location_names[64] = {
    "takable", "finger", "neck",      "body", "head",       "legs", "feet", "hands", "arms", "shield", "cloak",
    "belt",    "wrist",  "wieldable", "held", "two_handed", "",     "",     "",      "",     "",       "",
    "",        "",       "",          "",     "",           "",     "",     "",      "",     "",       "",
    "",        "",       "",          "",     "",           "",     "",     "",      "",     "",       "",
    "",        "",       "",          "",     "",           "",     "",     "",      "",     "",       "",
    "",        "",       "",          "",     "",           "",     "",     "",      ""};

const char *item_extra_names[64] = {"glow",
                                    "hum",
                                    "metal",
                                    "mineral",
                                    "organic",
...
cJSON *process_obj_extra_descriptions(cJSON *this_obj, objects *Objects, int i)
{
    ...
    if (Objects->Object[i].ExtraCount)
    {
        ...
        for (int j = 0; j < Objects->Object[i].ExtraCount; j++)
        {
            ...
            {
                keywords = cJSON_CreateStringArray((const char *const *)Objects->Object[i].Extra[j].Keyword->Word,
                                                   Objects->Object[i].Extra[j].Keyword->Count);
...
cJSON *process_item_weapon(cJSON *this_obj, objects *Objects, int i)
{
    ...
    cJSON_AddRawDiceToObject(type_details, "damage", Objects->Object[i].Flags.Value[1],
