...
const int afk_convertsectors[] = {AFK_SECT_INDOORS,      AFK_SECT_INDOORS, AFK_SECT_CITY,      AFK_SECT_FIELD,
                                  AFK_SECT_FOREST,       AFK_SECT_HILLS,   AFK_SECT_MOUNTAIN,  AFK_SECT_WATER_SWIM,
                                  AFK_SECT_WATER_NOSWIM, AFK_SECT_AIR,     AFK_SECT_UNDERWATER};
...
char *const afk_dir_name[] = {"north",     "east",      "south",     "west",      "up",       "down",
                              "northeast", "northwest", "southeast", "southwest", "somewhere"};

char *const afk_area_flags[] = {"nopkill",    "nocamp", "noastral", "noportal", "norecall", "nosummon", "noscry",
                                "noteleport", "arena",  "nobeacon", "noquit",   "r11",      "r12",      "r13",
                                "r14",        "r15",    "r16",      "r17",      "r18",      "r19",      "r20",
                                "r21",        "r22",    "r23",      "r24",      "r25",      "r26",      "r27",
                                "r28",        "r29",    "r30",      "r31"};

char *const afk_ex_flags[] = {
    "isdoor",    "closed",     "locked",    "secret",     "swim",   "pickproof", "fly",       "climb",     "dig",
    "eatkey",    "nopassdoor", "hidden",    "passage",    "portal", "overland",  "arrowslit", "can_climb", "can_enter",
    "can_leave", "auto",       "noflee",    "searchable", "bashed", "bashproof", "nomob",     "window",    "can_look",
    "isbolt",    "bolted",     "fortified", "heavy",      "medium", "light",     "crumbling", "destroyed", ""};

char *const afk_r_flags[] = {"dark",         "death",        "nomob",    "indoors",       "safe",
                             "nocamp",       "nosummon",     "nomagic",  "tunnel",        "private",
                             "silence",      "nosupplicate", "arena",    "nomissile",     "norecall",
                             "noportal",     "noastral",     "nodrop",   "clanstoreroom", "teleport",
                             "teleshowdesc", "nofloor",      "solitary", "petshop",       "donation",
                             "nodropall",    "logspeech",    "proto",    "noteleport",    "noscry",
                             "cave",         "cavern",       "nobeacon", "auction",       "map",
                             "forge",        "guildinn",     "deleted",  "isolated",      "watchtower",
                             "noquit",       "telenofly",    ""};
...
char *const afk_sect_types[] = {
    "indoors",    "city",   "field",     "forest",     "hills",       "mountain",  "water_swim", "water_noswim", "air",
    "underwater", "desert", "river",     "oceanfloor", "underground", "jungle",    "swamp",      "tundra",       "ice",
    "ocean",      "lava",   "shore",     "tree",       "stone",       "quicksand", "wall",       "glacier",      "exit",
    "trail",      "blands", "grassland", "scrub",      "barren",      "bridge",    "road",       "landing",      "\n"};

char *const afk_o_types[] = {
    "none",   "light",      "scroll",        "wand",       "staff",    "weapon",  "UNUSED1",   "UNUSED2",  "treasure",
    "armor",  "potion",     "UNUSED3",       "furniture",  "trash",    "UNUSED4", "container", "UNUSED5",  "drinkcon",
    "key",    "food",       "money",         "pen",        "boat",     "corpse",  "corpse_pc", "fountain", "pill",
    "blood",  "bloodstain", "scraps",        "pipe",       "herbcon",  "herb",    "incense",   "fire",     "book",
    "switch", "lever",      "pullchain",     "button",     "dial",     "rune",    "runepouch", "match",    "trap",
    "map",    "portal",     "paper",         "tinder",     "lockpick", "spike",   "disease",   "oil",      "fuel",
    "piece",  "tree",       "missileweapon", "projectile", "quiver",   "shovel",  "salve",     "cook",     "keyring",
    "odor",   "campgear",   "drinkmix",      "instrument", "ore"};

char *const afk_o_flags[] = {
    "glow",       "hum",       "metal",       "mineral",     "organic",     "invis",      "magic",      "nodrop",
    "bless",      "antigood",  "antievil",    "antineutral", "anticleric",  "antimage",   "antirogue",  "antiwarrior",
    "inventory",  "noremove",  "twohand",     "evil",        "donated",     "clanobject", "clancorpse", "antibard",
    "hidden",     "antidruid", "poisoned",    "covering",    "deathrot",    "buried",     "proto",      "nolocate",
    "groundrot",  "antimonk",  "loyal",       "brittle",     "resistant",   "immune",     "antimen",    "antiwomen",
    "antineuter", "antiherma", "antisun",     "antiranger",  "antipaladin", "antinecro",  "antiapal",   "onlycleric",
    "onlymage",   "onlyrogue", "onlywarrior", "onlybard",    "onlydruid",   "onlymonk",   "onlyranger", "onlypaladin",
    "onlynecro",  "onlyapal",  "auction",     "onmap",       "personal",    "lodged",     "sindhae",    "mustmount",
    "noauction",  ""};

char *const afk_w_flags[] = {"take",  "finger", "finger",    "neck",      "neck",      "body",    "head",  "legs",
                             "feet",  "hands",  "arms",      "shield",    "about",     "waist",   "wrist", "wrist",
                             "wield", "hold",   "dual",      "ears",      "eyes",      "missile", "back",  "face",
                             "ankle", "ankle",  "lodge_rib", "lodge_arm", "lodge_leg", "r7",      "r8",    "r9",
                             "r10",   "r11",    "r12",       "r13"};

char *const afk_mag_flags[] = {"returning", "backstabber", "bane", "loyal", "haste", "drain", "lightning_blade",
...
char *const afk_act_flags[] = {
    "npc",         "sentinel",    "scavenger",  "innkeeper", "banker",    "aggressive", "stayarea",  "wimpy",
    "pet",         "autonomous",  "practice",   "immortal",  "deadly",    "polyself",   "meta_aggr", "guardian",
    "boarded",     "nowander",    "mountable",  "mounted",   "scholar",   "secretive",  "hardhat",   "mobinvis",
    "noassist",    "illusion",    "pacifist",   "noattack",  "annoying",  "auction",    "proto",     "mage",
    "warrior",     "cleric",      "rogue",      "druid",     "monk",      "paladin",    "ranger",    "necromancer",
    "antipaladin", "huge",        "greet",      "teacher",   "onmap",     "smith",      "guildauc",  "guildbank",
    "guildvendor", "guildrepair", "guildforge", "idmob",     "guildidmob"};

char *const afk_a_flags[] = {"blind",        "invisible",     "detect_evil",    "detect_invis",
                             "detect_magic", "detect_hidden", "hold",           "sanctuary",
                             "faerie_fire",  "infrared",      "curse",          "spy",
                             "poison",       "protect",       "paralysis",      "sneak",
                             "hide",         "sleep",         "charm",          "flying",
                             "acidmist",     "floating",      "truesight",      "detect_traps",
                             "scrying",      "fireshield",    "shockshield",    "venomshield",
                             "iceshield",    "wizardeye", /* Max obj affect - stupid BV
                                                           * shit */
                             "berserk",      "aqua_breath",   "recurringspell", "contagious",
                             "bladebarrier", "silence",       "animal_invis",   "heat_stuff",
                             "life_prot",    "dragonride",    "growth",         "tree_travel",
                             "travelling",   "telepathy",     "ethereal",       "passdoor",
                             "quiv",         "_flaming",      "haste",          "slow",
                             "elvensong",    "bladesong",     "reverie",        "tenacity",
                             "deathsong",    "possess",       "notrack",        "enlighten",
                             "treetalk",     "spamguard",     "bash",           ""};

char *const afk_lang_names[] = {"common",  "elvish",    "dwarven",  "pixie",    "ogre",   "orcish",    "trollese",
                                "rodent",  "insectoid", "mammal",   "reptile",  "dragon", "spiritual", "magical",
                                "goblin",  "god",       "ancient",  "halfling", "clan",   "gith",      "minotaur",
                                "centaur", "gnomish",   "sahuagin", ""};

char *const afk_npc_position[] = {"dead",     "mortal",  "incapacitated", "stunned",  "sleeping",  "resting",
                                  "sitting",  "berserk", "aggressive",    "fighting", "defensive", "evasive",
                                  "standing", "mounted", "shove",         "drag"};

char *const afk_sex[] = {"neuter", "male", "female", "hermaphrodyte"};
...
char *const afk_npc_class[] = {"mage",    "cleric",     "rogue",      "warrior",     "necromancer", "druid", "ranger",
...
char *const afk_attack_flags[] = {
    ...
    "bash",        "stun",         "gouge",        "backstab",      "age",    "drain",       "firebreath",
...
char *const afk_defense_flags[] = {"parry",       "dodge",      "heal",      "curelight", "cureserious", "curecritical",
                                   "dispelmagic", "dispelevil", "sanctuary", "r1",        "r2",          "shield",
                                   "bless",       "stoneskin",  "teleport",  "r3",        "r4",          "r5",
                                   "r6",          "disarm",     "r7",        "grip",      "truesight",   "r8",
                                   "r9",          "r10",        "r11",       "r12"};

char *const afk_ris_flags[] = {"fire",   "cold",  "electricity", "energy", "blunt", "pierce",    "slash", "acid",
                               "poison", "drain", "sleep",       "charm",  "hold",  "nonmagic",  "plus1", "plus2",
                               "plus3",  "plus4", "plus5",       "plus6",  "magic", "paralysis", "good",  "evil",
                               "hack",   "lash",  "r5",          "r6",     "r7",    "r8",        "r9",    "r10"};
...
void dump_as_afk(zones *Zones, rooms *Rooms, shops *Shops, objects *Objects, mobs *Mobs)
{
	...
	fprintf(ofp, "#COORDS %d %d\n\n", tarea->x, tarea->y);
         ...
         */
        fprintf(ofp, "#CLIMATE %d %d %d\n\n", AFK_CLIMATE_TEMP_NORMAL, AFK_CLIMATE_PRECIP_NORMAL,
	...
	for (neigh = tarea->weather->first_neighbor; neigh; neigh = neigh->next)
        ...
        for (j = 0; j < Mobs->Count; j++)
        {
                 ...
                 (Mobs->Mob[j].Number <= Zones->Zone[i].Top)))
            {
                ...
                fprintf(ofp, "%d %d %d %d %d %d %d %f\n", Mobs->Mob[j].Alignment,
                        (Mobs->Mob[j].Gold.Rolls * Mobs->Mob[j].Gold.Die) + Mobs->Mob[j].Gold.Modifier, 0, /* no
                                                                                                            * idea?
                                                                                                            */
                        Mobs->Mob[j].Height, Mobs->Mob[j].Weight, Mobs->Mob[j].MovePoints, Mobs->Mob[j].ManaPoints,
        ...
        /*
           ...
           strip_cr(mprog->comlist) ); fprintf( fpout, "%s", "|\n" );
            }
            }
        */
        fprintf(ofp, "%s", "#0\n\n\n");
        ...
        */
        ...
        for (j = 0; j < Objects->Count; j++)
        {
                 ...
                 (Objects->Object[j].Number <= Zones->Zone[i].Top)))
            {
                 ...
                 */
                val = afk_convert_item_values(Objects->Object[j].Type, Objects->Object[j].Flags.Value[0],
                ...
                fprintf(ofp, "%d %d %d %d %d %s %s %s\n", Objects->Object[j].Weight, Objects->Object[j].Value,
                        Objects->Object[j].Rent, 9999, /* Unlimited
                                                        */
                 ...
                 (Rooms->Room[j].Number <= Zones->Zone[i].Top)))
            {
                ...
                for (k = 0; k < Rooms->Room[j].ExitCount; k++)
                {
                    ...
                    case EXIT_ONE_WAY:
                         ...
                         */
                        fprintf(ofp, "%d %d %d %d\n", Rooms->Room[j].Exit[k].KeyNumber, Rooms->Room[j].Exit[k].Room, -1,
                                -1);
                    }
                }
