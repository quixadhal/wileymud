...
void smaug_convert_attack(EXT_BV *NewValue, int OldValue) {
  switch(OldValue) {
    case TYPE_HIT: break; // xSET_BIT(*NewValue, smaug_get_attackflag("hit")); break;
    case TYPE_BLUDGEON: xSET_BIT(*NewValue, smaug_get_attackflag("punch")); break;
    case TYPE_PIERCE: break; // xSET_BIT(*NewValue, smaug_get_attackflag("hit")); break;
    case TYPE_SLASH: break; // xSET_BIT(*NewValue, smaug_get_attackflag("hit")); break;
    case TYPE_WHIP: xSET_BIT(*NewValue, smaug_get_attackflag("tail")); break;
    case TYPE_CLAW: xSET_BIT(*NewValue, smaug_get_attackflag("claws")); break;
    case TYPE_BITE: xSET_BIT(*NewValue, smaug_get_attackflag("bite")); break;
    case TYPE_STING: xSET_BIT(*NewValue, smaug_get_attackflag("sting")); break;
    case TYPE_CRUSH: xSET_BIT(*NewValue, smaug_get_attackflag("bash")); break;
    case TYPE_CLEAVE: xSET_BIT(*NewValue, smaug_get_attackflag("gouge")); break;
    case TYPE_STAB: break; // xSET_BIT(*NewValue, smaug_get_attackflag("hit")); break;
    case TYPE_SMASH: xSET_BIT(*NewValue, smaug_get_attackflag("bash")); break;
    case TYPE_SMITE: xSET_BIT(*NewValue, smaug_get_attackflag("stun")); break;
    case TYPE_SUFFERING: xSET_BIT(*NewValue, smaug_get_attackflag("poison")); break;
    case TYPE_HUNGER: break; // xSET_BIT(*NewValue, smaug_get_attackflag("hit")); break;
    default: break;
  }
}
...
EXT_BV smaug_convert_imm(int OldValue) {
  ...
  if(OldValue & IMM_FIRE) xSET_BIT(NewValue, smaug_get_rflag("fire"));
  if(OldValue & IMM_COLD) xSET_BIT(NewValue, smaug_get_rflag("cold"));
  if(OldValue & IMM_ELEC) xSET_BIT(NewValue, smaug_get_rflag("electricity"));
  if(OldValue & IMM_ENERGY) xSET_BIT(NewValue, smaug_get_rflag("energy"));
  if(OldValue & IMM_BLUNT) xSET_BIT(NewValue, smaug_get_rflag("blunt"));
  if(OldValue & IMM_PIERCE) xSET_BIT(NewValue, smaug_get_rflag("pierce"));
  if(OldValue & IMM_SLASH) xSET_BIT(NewValue, smaug_get_rflag("slash"));
  if(OldValue & IMM_ACID) xSET_BIT(NewValue, smaug_get_rflag("acid"));
  if(OldValue & IMM_POISON) xSET_BIT(NewValue, smaug_get_rflag("poison"));
  if(OldValue & IMM_DRAIN) xSET_BIT(NewValue, smaug_get_rflag("drain"));
  if(OldValue & IMM_SLEEP) xSET_BIT(NewValue, smaug_get_rflag("sleep"));
  if(OldValue & IMM_CHARM) xSET_BIT(NewValue, smaug_get_rflag("charm"));
  if(OldValue & IMM_HOLD) xSET_BIT(NewValue, smaug_get_rflag("hold"));
  if(OldValue & IMM_NONMAG) xSET_BIT(NewValue, smaug_get_rflag("nonmagic"));
  if(OldValue & IMM_PLUS1) xSET_BIT(NewValue, smaug_get_rflag("plus1"));
  if(OldValue & IMM_PLUS2) xSET_BIT(NewValue, smaug_get_rflag("plus2"));
  if(OldValue & IMM_PLUS3) xSET_BIT(NewValue, smaug_get_rflag("plus3"));
  if(OldValue & IMM_PLUS4) xSET_BIT(NewValue, smaug_get_rflag("plus4"));
...
int smaug_convertsex(int Sex) {
  switch(Sex) {
    case SEX_NEUTER: return smaug_get_sex("neuter");
    case SEX_MALE: return smaug_get_sex("male");
    case SEX_FEMALE: return smaug_get_sex("female");
    default: return smaug_get_sex("neuter");
  }
}

int smaug_convertposition(int Position) {
  switch(Position) {
    case POSITION_DEAD:  return smaug_get_position("dead");
    case POSITION_MORTALLYW: return smaug_get_position("mortal");
    case POSITION_INCAP: return smaug_get_position("incapacitated");
    case POSITION_STUNNED: return smaug_get_position("stunned");
    case POSITION_SLEEPING: return smaug_get_position("sleeping");
    case POSITION_RESTING: return smaug_get_position("resting");
    case POSITION_SITTING: return smaug_get_position("sitting");
    case POSITION_FIGHTING: return smaug_get_position("fighting");
    case POSITION_STANDING: return smaug_get_position("standing");
    case POSITION_MOUNTED: return smaug_get_position("mounted");
    default: return smaug_get_position("standing");
  }
}

int smaug_convertobjtype(int Type) {
  switch(Type) {
    case ITEM_LIGHT: return smaug_get_otype("light");
    case ITEM_SCROLL: return smaug_get_otype("scroll");
    case ITEM_WAND: return smaug_get_otype("wand");
    case ITEM_STAFF: return smaug_get_otype("staff");
    case ITEM_WEAPON: return smaug_get_otype("weapon");
    case ITEM_FIREWEAPON: return smaug_get_otype("weapon");
    case ITEM_MISSILE: return smaug_get_otype("projectile");
    case ITEM_TREASURE: return smaug_get_otype("treasure");
    case ITEM_ARMOR: return smaug_get_otype("armor");
    case ITEM_POTION: return smaug_get_otype("potion");
    case ITEM_TRASH: return smaug_get_otype("trash");
    case ITEM_TRAP: return smaug_get_otype("trap");
    case ITEM_CONTAINER: return smaug_get_otype("container");
    case ITEM_NOTE: return smaug_get_otype("paper");
    case ITEM_DRINKCON: return smaug_get_otype("drinkcon");
    case ITEM_KEY: return smaug_get_otype("key");
    case ITEM_FOOD: return smaug_get_otype("food");
    case ITEM_MONEY: return smaug_get_otype("money");
    case ITEM_PEN: return smaug_get_otype("pen");
    case ITEM_BOAT: return smaug_get_otype("boat");
    ...
    case ITEM_BOARD:
    case ITEM_KENNEL:
    default: return smaug_get_otype("none");
  }
}
...
EXT_BV smaug_convert_rflags(int OldValue) {
  ...
  memset(&NewValue, '\0', sizeof(EXT_BV));
  if(OldValue & ROOM_DARK) xSET_BIT(NewValue, smaug_get_rflag("dark"));
  if(OldValue & ROOM_DEATH) xSET_BIT(NewValue, smaug_get_rflag("death"));
  if(OldValue & ROOM_NOMOB) xSET_BIT(NewValue, smaug_get_rflag("nomob"));
  if(OldValue & ROOM_INDOORS) xSET_BIT(NewValue, smaug_get_rflag("indoors"));
  if(OldValue & ROOM_NOATTACK) xSET_BIT(NewValue, smaug_get_rflag("safe"));
  /* if(OldValue & ROOM_NOSTEAL) NewValue |= */
  if(OldValue & ROOM_NOSUMMON) xSET_BIT(NewValue, smaug_get_rflag("nosummon"));
  if(OldValue & ROOM_NOMAGIC) xSET_BIT(NewValue, smaug_get_rflag("nomagic"));
  if(OldValue & ROOM_PRIVATE) xSET_BIT(NewValue, smaug_get_rflag("private"));
...
EXT_BV smaug_convert_oflags(int OldValue) {
  ...
  memset(&NewValue, '\0', sizeof(EXT_BV));
  if(OldValue & ITEM_GLOW) xSET_BIT(NewValue, smaug_get_oflag("glow"));
  if(OldValue & ITEM_HUM) xSET_BIT(NewValue, smaug_get_oflag("hum"));
  if(OldValue & ITEM_METAL) xSET_BIT(NewValue, smaug_get_oflag("metal"));
  if(OldValue & ITEM_MINERAL) xSET_BIT(NewValue, smaug_get_oflag("mineral"));
  if(OldValue & ITEM_ORGANIC) xSET_BIT(NewValue, smaug_get_oflag("organic"));
  if(OldValue & ITEM_INVISIBLE) xSET_BIT(NewValue, smaug_get_oflag("invis"));
  if(OldValue & ITEM_MAGIC) xSET_BIT(NewValue, smaug_get_oflag("magic"));
  if(OldValue & ITEM_NODROP) xSET_BIT(NewValue, smaug_get_oflag("nodrop"));
  if(OldValue & ITEM_BLESS) xSET_BIT(NewValue, smaug_get_oflag("bless"));
  if(OldValue & ITEM_ANTI_GOOD) xSET_BIT(NewValue, smaug_get_oflag("antigood"));
  if(OldValue & ITEM_ANTI_EVIL) xSET_BIT(NewValue, smaug_get_oflag("antievil"));
  if(OldValue & ITEM_ANTI_NEUTRAL) xSET_BIT(NewValue, smaug_get_oflag("antineutral"));
  if(OldValue & ITEM_ANTI_CLERIC) xSET_BIT(NewValue, smaug_get_oflag("anticleric"));
  if(OldValue & ITEM_ANTI_MAGE) xSET_BIT(NewValue, smaug_get_oflag("antimage"));
  if(OldValue & ITEM_ANTI_THIEF) xSET_BIT(NewValue, smaug_get_oflag("antirogue"));
  if(OldValue & ITEM_ANTI_FIGHTER) xSET_BIT(NewValue, smaug_get_oflag("antiwarrior"));
  if(OldValue & ITEM_ANTI_RANGER) xSET_BIT(NewValue, smaug_get_oflag("antiranger"));
...
int smaug_convert_wflags(int OldValue) {
  ...
  if(OldValue & ITEM_TAKE) SET_BIT(NewValue, smaug_get_wflag("take"));
  if(OldValue & ITEM_WEAR_FINGER) SET_BIT(NewValue, smaug_get_wflag("finger"));
  if(OldValue & ITEM_WEAR_NECK) SET_BIT(NewValue, smaug_get_wflag("neck"));
  if(OldValue & ITEM_WEAR_BODY) SET_BIT(NewValue, smaug_get_wflag("body"));
  if(OldValue & ITEM_WEAR_HEAD) SET_BIT(NewValue, smaug_get_wflag("head"));
  if(OldValue & ITEM_WEAR_LEGS) SET_BIT(NewValue, smaug_get_wflag("legs"));
  if(OldValue & ITEM_WEAR_FEET) SET_BIT(NewValue, smaug_get_wflag("feet"));
  if(OldValue & ITEM_WEAR_HANDS) SET_BIT(NewValue, smaug_get_wflag("hands"));
  if(OldValue & ITEM_WEAR_ARMS) SET_BIT(NewValue, smaug_get_wflag("arms"));
  if(OldValue & ITEM_WEAR_SHIELD) SET_BIT(NewValue, smaug_get_wflag("shield"));
  if(OldValue & ITEM_WEAR_ABOUT) SET_BIT(NewValue, smaug_get_wflag("about"));
  if(OldValue & ITEM_WEAR_WAISTE) SET_BIT(NewValue, smaug_get_wflag("waist"));
  if(OldValue & ITEM_WEAR_WRIST) SET_BIT(NewValue, smaug_get_wflag("wrist"));
  if(OldValue & ITEM_WIELD) SET_BIT(NewValue, smaug_get_wflag("wield"));
  if(OldValue & ITEM_HOLD) SET_BIT(NewValue, smaug_get_wflag("hold"));
  if(OldValue & ITEM_WIELD_TWOH) SET_BIT(NewValue, smaug_get_wflag("dual"));
...
EXT_BV smaug_convert_actflags(int OldValue) {
  ...
  if(OldValue & ACT_SENTINEL) xSET_BIT(NewValue, smaug_get_actflag("sentinel"));
  if(OldValue & ACT_SCAVENGER) xSET_BIT(NewValue, smaug_get_actflag("scavenger"));
  if(OldValue & ACT_ISNPC) ; // NOOP
  if(OldValue & ACT_NICE_THIEF) ;// NOOP
  if(OldValue & ACT_AGGRESSIVE) xSET_BIT(NewValue, smaug_get_actflag("aggressive"));
  if(OldValue & ACT_STAY_ZONE) xSET_BIT(NewValue, smaug_get_actflag("stayarea"));
  if(OldValue & ACT_WIMPY) xSET_BIT(NewValue, smaug_get_actflag("wimpy"));
  if(OldValue & ACT_ANNOYING) xSET_BIT(NewValue, smaug_get_actflag("annoying"));
  if(OldValue & ACT_HATEFUL) ; // NOOP
  if(OldValue & ACT_AFRAID) ; // NOOP
  if(OldValue & ACT_IMMORTAL) xSET_BIT(NewValue, smaug_get_actflag("immortal"));
  if(OldValue & ACT_HUNTING) ; // NOOP
  if(OldValue & ACT_DEADLY) xSET_BIT(NewValue, smaug_get_actflag("deadly"));
  if(OldValue & ACT_GUARDIAN) xSET_BIT(NewValue, smaug_get_actflag("guardian"));
  if(OldValue & ACT_USE_ITEM) ; // NOOP
  if(OldValue & ACT_FIGHTER_MOVES) xSET_BIT(NewValue, smaug_get_actflag("meta_aggr")); // Not quite
  if(OldValue & ACT_FOOD_PROVIDE) ; // NOOP
  if(OldValue & ACT_PROTECTOR) ; // NOOP
  if(OldValue & ACT_MOUNT) xSET_BIT(NewValue, smaug_get_actflag("mountable"));
...
EXT_BV smaug_convert_aflags(int OldValue) {
  ...
  if(OldValue & AFF_BLIND) xSET_BIT(NewValue, smaug_get_aflag("blind"));
  if(OldValue & AFF_INVISIBLE) xSET_BIT(NewValue, smaug_get_aflag("invisible"));
  if(OldValue & AFF_DETECT_EVIL) xSET_BIT(NewValue, smaug_get_aflag("detect_evil"));
  if(OldValue & AFF_DETECT_INVISIBLE) xSET_BIT(NewValue, smaug_get_aflag("detect_invis"));
  if(OldValue & AFF_DETECT_MAGIC) xSET_BIT(NewValue, smaug_get_aflag("detect_magic"));
  if(OldValue & AFF_SENSE_LIFE) xSET_BIT(NewValue, smaug_get_aflag("detect_hidden")); // Not quite

  if(OldValue & AFF_SILENCED) xSET_BIT(NewValue, smaug_get_aflag("silence"));
  if(OldValue & AFF_SANCTUARY) xSET_BIT(NewValue, smaug_get_aflag("sanctuary"));
  if(OldValue & AFF_GROUP) ; // NOOP
  if(OldValue & AFF_CURSE) xSET_BIT(NewValue, smaug_get_aflag("curse"));
  if(OldValue & AFF_FLYING) xSET_BIT(NewValue, smaug_get_aflag("flying"));
  if(OldValue & AFF_POISON) xSET_BIT(NewValue, smaug_get_aflag("poison"));
  if(OldValue & AFF_PROTECT_EVIL) xSET_BIT(NewValue, smaug_get_aflag("protect"));
  if(OldValue & AFF_PARALYSIS) xSET_BIT(NewValue, smaug_get_aflag("paralysis"));
  if(OldValue & AFF_INFRAVISION) ; // NOOP
  if(OldValue & AFF_WATERBREATH) xSET_BIT(NewValue, smaug_get_aflag("aqua_breath"));
  if(OldValue & AFF_SLEEP) xSET_BIT(NewValue, smaug_get_aflag("sleep"));
  if(OldValue & AFF_DRUG_FREE) ; // NOOP
  if(OldValue & AFF_SNEAK) xSET_BIT(NewValue, smaug_get_aflag("sneak"));
  if(OldValue & AFF_HIDE) xSET_BIT(NewValue, smaug_get_aflag("hide"));
  if(OldValue & AFF_FEAR) ; // NOOP
  if(OldValue & AFF_CHARM) ; // NOOP
  if(OldValue & AFF_FOLLOW) ; // NOOP
  if(OldValue & AFF_UNDEF_1) ; // NOOP
  if(OldValue & AFF_TRUE_SIGHT) xSET_BIT(NewValue, smaug_get_aflag("truesight"));
  if(OldValue & AFF_SCRYING) xSET_BIT(NewValue, smaug_get_aflag("scrying"));
  if(OldValue & AFF_FIRESHIELD) xSET_BIT(NewValue, smaug_get_aflag("fireshield")); // Not quite
...
char *smaug_flag_string( int bitvector, char * const flagarray[] )
{
    static char buf[MSL];
    int x = 0;
...
int * smaug_convert_item_values(int Type, int w0, int w1, int w2, int w3) {
  static int a[11];
...
void dump_as_smaug(zones *Zones, rooms *Rooms, shops *Shops, objects *Objects, mobs *Mobs) {
  ...
  sprintf(filename, "%s/%s/area.lst", OutputDir, SMAUG_SUBDIR);
  ...
  for(i= 0; i< Zones->Count; i++) {
    ...
    fprintf(listfp, "%s\n", tmpstr);
    sprintf(filename, "%s/%s/%s", OutputDir, SMAUG_SUBDIR, tmpstr);
...
/* ZONE */
    ...
    fprintf( ofp, "Ranges    %d %d %d %d\n",
             SMAUG_AREA_LEVEL_LIMIT_LOWER, SMAUG_AREA_LEVEL_LIMIT_UPPER,   /* SOFT (displayed) limits */
...
/* MOBS */
    ...
    for(j= 0; j< Mobs->Count; j++) {
      if((remap_zone_vnum(Zones, Mobs->Mob[j].Zone) == i) ||
        ...
        fprintf(ofp, "Stats1    %d %d %d %d %d %d\n", Mobs->Mob[j].Alignment,
                ...
                (Mobs->Mob[j].Experience.Rolls * Mobs->Mob[j].Experience.Die) + Mobs->Mob[j].Experience.Modifier);

        fprintf(ofp, "Stats2    %d %d %d\n",
                Mobs->Mob[j].HitPoints.Rolls, Mobs->Mob[j].HitPoints.Die, Mobs->Mob[j].HitPoints.Modifier);
        ...
        fprintf(ofp, "Stats4    %d %d %d %d %d\n", Mobs->Mob[j].Height, Mobs->Mob[j].Weight,
                Mobs->Mob[j].AttackCount, Mobs->Mob[j].ToHit, avg.Rolls * avg.Die/2 + avg.Modifier);

        fprintf(ofp, "Attribs   %d %d %d %d %d %d %d\n",
                Mobs->Mob[j].Strength.Rolls * Mobs->Mob[j].Strength.Die/2 + Mobs->Mob[j].Strength.Modifier,
                Mobs->Mob[j].Intelligence.Rolls * Mobs->Mob[j].Intelligence.Die/2 + Mobs->Mob[j].Intelligence.Modifier,
                Mobs->Mob[j].Wisdom.Rolls * Mobs->Mob[j].Wisdom.Die/2 + Mobs->Mob[j].Wisdom.Modifier,
                Mobs->Mob[j].Dexterity.Rolls * Mobs->Mob[j].Dexterity.Die/2 + Mobs->Mob[j].Dexterity.Modifier,
                Mobs->Mob[j].Constitution.Rolls * Mobs->Mob[j].Constitution.Die/2 + Mobs->Mob[j].Constitution.Modifier,
                /* No Charisma */ 14,
                /* No Luck */ 14);

        fprintf(ofp, "Saves     %d %d %d %d %d\n", Mobs->Mob[j].SavingThrow[0], Mobs->Mob[j].SavingThrow[1],
                Mobs->Mob[j].SavingThrow[2], Mobs->Mob[j].SavingThrow[3], Mobs->Mob[j].SavingThrow[4] );
	...
	//fprintf(ofp, "%s~\n", smaug_ext_flag_string( &ImmValue, smaug_ris_flags) ); // absorb -- Wiley has none

        fprintf(ofp, "Position  %s~\n", smaug_npc_position[smaug_convertposition(Mobs->Mob[j].Position)]);
        fprintf(ofp, "DefPos    %s~\n", smaug_npc_position[smaug_convertposition(Mobs->Mob[j].DefaultPosition)]);
...
/* OBJECTS */
    ...
    for(j= 0; j< Objects->Count; j++) {
      if((remap_zone_vnum(Zones, Objects->Object[j].Zone) == i) ||
        ...
        fprintf(ofp, "Type      %s~\n", smaug_strip_cr(smaug_o_types[smaug_convertobjtype(Objects->Object[j].Type)]));
	...
	fprintf(ofp, "Stats     %d %d %d %d %d\n",
           ...
           0, /* Wiley doesn't have item levels - Unlimited */
    ...
    for(j= 0; j< Rooms->Count; j++) {
      if((remap_zone_vnum(Zones, Rooms->Room[j].Zone) == i) ||
        ...
        if ( Rooms->Room[j].Sector == SECT_TELEPORT ) {
          fprintf(ofp, "Sector    %s~\n", smaug_strip_cr(smaug_sect_types[smaug_convertsector[Rooms->Room[j].TeleportSector]]));
        } else {
          fprintf(ofp, "Sector    %s~\n", smaug_strip_cr(smaug_sect_types[smaug_convertsector[Rooms->Room[j].Sector]]));
        }
        ...
        for(k= 0; k< Rooms->Room[j].ExitCount; k++) {
          switch(Rooms->Room[j].Exit[k].Error) {
            ...
            case EXIT_ONE_WAY:
              ...
              */
              fprintf( ofp, "#EXIT\n" );
              fprintf( ofp, "Direction %s~\n", smaug_strip_cr(smaug_dir_name[Rooms->Room[j].Exit[k].Direction] ));
              ...
              if(Rooms->Room[j].Exit[k].Keyword->Count > 0) {
                fprintf(ofp, "Keywords  %s", smaug_strip_cr(Rooms->Room[j].Exit[k].Keyword->Word[0]));
                for(x= 1; x< Rooms->Room[j].Exit[k].Keyword->Count; x++) {
                  fprintf(ofp, " %s", smaug_strip_cr(Rooms->Room[j].Exit[k].Keyword->Word[x]));
                }
                fprintf( ofp, "~\n" );
              }
        ...
        for(k= 0; k< Rooms->Room[j].ExtraCount; k++) {
          ...
          if(Rooms->Room[j].Extra[k].Keyword->Count > 0) {
            fprintf(ofp, "ExDescKey %s", smaug_strip_cr(Rooms->Room[j].Extra[k].Keyword->Word[0]));
            for(x= 1; x< Rooms->Room[j].Extra[k].Keyword->Count; x++) {
              fprintf(ofp, " %s", smaug_strip_cr(Rooms->Room[j].Extra[k].Keyword->Word[x]));
            }
          }
        ...
        switch(Zones->Zone[i].Cmds[x].Command) {
            ...
            case ZONE_CMD_DOOR:
                fprintf(ofp, "Reset %c %d %d %d %d\n",
                        ...
                        Zones->Zone[i].Cmds[x].Arg[1],
                        Zones->Zone[i].Cmds[x].Arg[2]);
                break;
            case ZONE_CMD_GIVE:
            case ZONE_CMD_REMOVE:
            case ZONE_CMD_LEAD:
