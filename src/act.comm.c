...
void 
do_land(struct char_data *ch, char *arg, int cmd)
{
  if (DEBUG)
    dlog("do_land");
...
void 
do_invis_off(struct char_data *ch, char *arg, int cmd)
{
  if (DEBUG)
    dlog("do_invis_off");
...
void 
do_commune(struct char_data *ch, char *argument, int cmd)
{
...
void 
do_split(struct char_data *ch, char *arguement, int cmd)
{
  struct char_data                *k,
                                  *vict;
...
void 
do_group_tell(struct char_data *ch, char *arguement, int cmd)
{
  struct char_data                *k,
                                  *vict;
  struct follow_type              *f;
...
void 
do_group_report(struct char_data *ch, char *arguement, int cmd)
{
  struct char_data                *k,
                                  *vict;
  struct follow_type              *f;
