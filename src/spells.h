...
#define MAX_EXIST_SPELL             103		/*
						 * move this and change it 
						 */
...
#define SPELL_TRAVELLING            142		/*
						 * faster move outdoors 
						 */
...
#define SKILL_RESCUE            52	/*
					 * f,r 
					 */
#define SKILL_DOOR_BASH	 	149	/*
					 * f,r 
					 */
#define SKILL_READ_MAGIC 	150	/*
					 * f,m,c,t,r 
					 */
#define SKILL_SCRIBE		151	/*
					 * m,c 
					 */
#define SKILL_BREW		152	/*
					 * m,c 
					 */
#define SKILL_PUNCH		153	/*
					 * f,c,r 
					 */
#define SKILL_TWO_HANDED	154	/*
					 * f,m,c,t,r 
					 */
#define SKILL_TWO_WEAPON	155	/*
					 * NONE 
					 */
#define SKILL_BANDAGE		156	/*
					 * f,m,c,t,r 
					 */
#define SKILL_SEARCH		157	/*
					 * t,r 
					 */
#define SKILL_SWIMMING		158	/*
					 * f,m,c,t,r 
					 */
#define SKILL_ENDURANCE		159	/*
					 * f,m,c,r,t 
					 */
#define SKILL_BARE_HAND		160	/*
					 * f,m,c,t,r 
					 */
#define SKILL_BLIND_FIGHTING	161	/*
					 * f,c,m,r,t 
					 */
#define SKILL_PARRY		162	/*
					 * f,r,t NOT PUT IN 
					 */
#define SKILL_APRAISE		163	/*
					 * f,m,c,t,r 
					 */
#define SKILL_SPEC_SMITE	164	/*
					 * f 
					 */
...
#define SKILL_SPEC_PIERCE	172	/*
					 * f 
					 */
#define SKILL_PEER		173	/*
					 * t,r 
					 */
#define SKILL_DETECT_NOISE	174	/*
					 * t,r 
					 */
#define SKILL_DODGE		175	/*
					 * m,c,t,r NOT PUT IN 
					 */
#define SKILL_BARTER		176	/*
					 * m,c,t 
					 */
#define SKILL_KNOCK_OUT		177	/*
					 * m,c,t NOT PUT IN 
					 */
#define SKILL_SPELLCRAFT	178	/*
					 * m,c 
					 */
#define SKILL_MEDITATION	179	/*
					 * m,c 
					 */
...
#define SKILL_FIND_TRAP         181	/*
					 * t 
					 */
#define SKILL_DISARM_TRAP       182	/*
					 * t 
					 */
#define SKILL_DISARM            183	/*
					 * f,r 
					 */
#define SKILL_BASH_W_SHIELD     184	/*
					 * not a useable skill, but included with bash 
					 */
...
#define TAR_ROOM         (1<<13)	/*
					 * spells which target the room  
					 */
...
struct spell_info_type {
  ...
  byte                             minimum_position;	/*
							 ...
							 */
  ubyte                            min_usesmana;	/*
							 * Amount of mana used by a spell        
							 */
  byte                             beats;	/*
						 * Heartbeats until ready for next 
						 */

  byte                             min_level_cleric;	/*
							 * Level required for cleric       
							 */
  byte                             min_level_magic;	/*
							 * Level required for magic user   
							 */
  sh_int                           targets;	/*
