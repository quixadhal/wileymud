...
#define REBOOT_AT1 9		/*
				 * 0-23, time of optional reboot if -e lib/reboot 
				 */
...
void 
bisect_arg(char *arg, int *field, char *string)
{
...
void 
do_cust(struct char_data *ch, char *arg, int cmd)
{
  int                              field,
                                   dflags,
                                   dir,
...
void 
do_setskill(struct char_data *ch, char *arg, int cmd)
{
...
nogames(void)
{
  ...
  if (fl = fopen(DFLT_DIR "/" NOGAMES_FILE, "r")) {
