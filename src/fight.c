...
int 
check_peaceful(struct char_data *ch, char *msg)
{
  struct room_data                *rp;
...
char                            *
replace_string(char *str, char *weapon, char *weapon_s)
{
  static char                      buf[256];
  char                            *cp;
...
struct char_data                *
FindVictim(struct char_data *ch)
{
...
struct char_data                *
FindAnyVictim(struct char_data *ch)
{
  struct char_data                *tmp_ch;
  unsigned char                    found = FALSE;
  unsigned short                   ftot = 0,
...
int 
PreProcDam(struct char_data *ch, int type, int dam)
{
  unsigned                         Our_Bit;
...
int 
DamageOneItem(struct char_data *ch, int dam_type, struct obj_data *obj)
{
  int                              num;
  char                             buf[256];
...
void 
MakeScrap(struct char_data *ch, struct obj_data *obj)
{
  char                             buf[200];
  struct obj_data                 *t;
...
void 
DamageAllStuff(struct char_data *ch, int dam_type)
{
  int                              j;
  struct obj_data                 *obj,
                                  *next;
...
int 
DamageItem(struct char_data *ch, struct obj_data *o, int num)
{
  /*
...
int 
ItemSave(struct obj_data *i, int dam_type)
{
  int                              num,
                                   j;
...
int 
DamagedByAttack(struct obj_data *i, int dam_type)
{
  int                              num = 0;
...
int 
WeaponCheck(struct char_data *ch, struct char_data *v, int type, int dam)
{
  int                              Immunity,
                                   total,
                                   j;
...
int 
DamageStuff(struct char_data *v, int type, int dam)
{
  int                              num,
                                   dam_type;
  struct obj_data                 *obj;
...
int 
SkipImmortals(struct char_data *v, int amnt)
{
  /*
...
int 
CheckKill(struct char_data *ch, struct char_data *vict)
{
  char                             buf[128];
...
int 
WeaponSpell(struct char_data *c, struct char_data *v, int type)
{
  int                              j,
                                   num;
...
struct char_data                *
FindAnAttacker(struct char_data *ch)
{
  struct char_data                *tmp_ch;
  unsigned char                    found = FALSE;
  unsigned short                   ftot = 0,
...
#if 0
void 
shoot(struct char_data *ch, struct char_data *victim)
{
...
int 
SwitchTargets(struct char_data *ch, struct char_data *vict)
{
  if (DEBUG)
    dlog("SwitchTargets");
  if (!ch->specials.fighting) {
