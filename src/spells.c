...
void cast_armor(int level, struct char_data *ch, const char *arg, int type, struct char_data *victim,
...
void cast_teleport(int level, struct char_data *ch, const char *arg, int type, struct char_data *victim,
                   struct obj_data *tar_obj)
{
    if (DEBUG > 1)
        log_info("called %s with %d, %s, %s, %d, %s, %s", __PRETTY_FUNCTION__, level, SAFE_NAME(ch), VNULL(arg), type,
...
void cast_bless(int level, struct char_data *ch, const char *arg, int type, struct char_data *victim,
                struct obj_data *tar_obj)
{
    if (DEBUG > 1)
        log_info("called %s with %d, %s, %s, %d, %s, %s", __PRETTY_FUNCTION__, level, SAFE_NAME(ch), VNULL(arg), type,
...
void cast_blindness(int level, struct char_data *ch, const char *arg, int type, struct char_data *victim,
                    struct obj_data *tar_obj)
{
    if (DEBUG > 1)
        log_info("called %s with %d, %s, %s, %d, %s, %s", __PRETTY_FUNCTION__, level, SAFE_NAME(ch), VNULL(arg), type,
...
void cast_charm_person(int level, struct char_data *ch, const char *arg, int type, struct char_data *victim,
                       struct obj_data *tar_obj)
{
    if (DEBUG > 1)
        log_info("called %s with %d, %s, %s, %d, %s, %s", __PRETTY_FUNCTION__, level, SAFE_NAME(ch), VNULL(arg), type,
...
void cast_clone(int level, struct char_data *ch, const char *arg, int type, struct char_data *victim,
                struct obj_data *tar_obj)
{
    ...
    case SPELL_TYPE_SPELL:
        ...
        else
        {
            ...
            act("$n creates a duplicate of %s %s,\r\n", FALSE, ch, 0, 0, TO_ROOM, SANA(tar_obj),
...
void cast_control_weather(int level, struct char_data *ch, const char *arg, int type, struct char_data *victim,
                          struct obj_data *tar_obj)
{
...
void cast_create_food(int level, struct char_data *ch, const char *arg, int type, struct char_data *victim,
                      struct obj_data *tar_obj)
{
    if (DEBUG > 1)
        log_info("called %s with %d, %s, %s, %d, %s, %s", __PRETTY_FUNCTION__, level, SAFE_NAME(ch), VNULL(arg), type,
...
void cast_create_water(int level, struct char_data *ch, const char *arg, int type, struct char_data *victim,
                       struct obj_data *tar_obj)
{
    if (DEBUG > 1)
        log_info("called %s with %d, %s, %s, %d, %s, %s", __PRETTY_FUNCTION__, level, SAFE_NAME(ch), VNULL(arg), type,
...
void cast_cure_blind(int level, struct char_data *ch, const char *arg, int type, struct char_data *victim,
                     struct obj_data *tar_obj)
{
    if (DEBUG > 1)
        log_info("called %s with %d, %s, %s, %d, %s, %s", __PRETTY_FUNCTION__, level, SAFE_NAME(ch), VNULL(arg), type,
...
void cast_resurrection(int level, struct char_data *ch, const char *arg, int type, struct char_data *victim,
                       struct obj_data *tar_obj)
{
    if (DEBUG > 1)
        log_info("called %s with %d, %s, %s, %d, %s, %s", __PRETTY_FUNCTION__, level, SAFE_NAME(ch), VNULL(arg), type,
...
void cast_mana(int level, struct char_data *ch, const char *arg, int type, struct char_data *victim,
               struct obj_data *tar_obj)
{
    if (DEBUG > 1)
        log_info("called %s with %d, %s, %s, %d, %s, %s", __PRETTY_FUNCTION__, level, SAFE_NAME(ch), VNULL(arg), type,
...
void cast_stone_skin(int level, struct char_data *ch, const char *arg, int type, struct char_data *victim,
                     struct obj_data *tar_obj)
{
    if (DEBUG > 1)
        log_info("called %s with %d, %s, %s, %d, %s, %s", __PRETTY_FUNCTION__, level, SAFE_NAME(ch), VNULL(arg), type,
    ...
    {
    case SPELL_TYPE_SPELL:
        if (affected_by_spell(ch, SPELL_STONE_SKIN) || affected_by_spell(ch, SPELL_ARMOR) ||
...
void cast_astral_walk(int level, struct char_data *ch, const char *arg, int type, struct char_data *victim,
                      struct obj_data *tar_obj)
{
    if (DEBUG > 1)
        log_info("called %s with %d, %s, %s, %d, %s, %s", __PRETTY_FUNCTION__, level, SAFE_NAME(ch), VNULL(arg), type,
...
void cast_visions(int level, struct char_data *ch, const char *arg, int type, struct char_data *victim,
                  struct obj_data *tar_obj)
{
    if (DEBUG > 1)
        log_info("called %s with %d, %s, %s, %d, %s, %s", __PRETTY_FUNCTION__, level, SAFE_NAME(ch), VNULL(arg), type,
...
void cast_infravision(int level, struct char_data *ch, const char *arg, int type, struct char_data *victim,
                      struct obj_data *tar_obj)
{
    if (DEBUG > 1)
        log_info("called %s with %d, %s, %s, %d, %s, %s", __PRETTY_FUNCTION__, level, SAFE_NAME(ch), VNULL(arg), type,
...
void cast_true_seeing(int level, struct char_data *ch, const char *arg, int type, struct char_data *victim,
                      struct obj_data *tar_obj)
{
    if (DEBUG > 1)
        log_info("called %s with %d, %s, %s, %d, %s, %s", __PRETTY_FUNCTION__, level, SAFE_NAME(ch), VNULL(arg), type,
...
void cast_light(int level, struct char_data *ch, const char *arg, int type, struct char_data *victim,
                struct obj_data *tar_obj)
{
    if (DEBUG > 1)
        log_info("called %s with %d, %s, %s, %d, %s, %s", __PRETTY_FUNCTION__, level, SAFE_NAME(ch), VNULL(arg), type,
...
void cast_cont_light(int level, struct char_data *ch, const char *arg, int type, struct char_data *victim,
                     struct obj_data *tar_obj)
{
    if (DEBUG > 1)
        log_info("called %s with %d, %s, %s, %d, %s, %s", __PRETTY_FUNCTION__, level, SAFE_NAME(ch), VNULL(arg), type,
...
void cast_calm(int level, struct char_data *ch, const char *arg, int type, struct char_data *victim,
               struct obj_data *tar_obj)
{
    if (DEBUG > 1)
        log_info("called %s with %d, %s, %s, %d, %s, %s", __PRETTY_FUNCTION__, level, SAFE_NAME(ch), VNULL(arg), type,
...
void cast_water_breath(int level, struct char_data *ch, const char *arg, int type, struct char_data *victim,
                       struct obj_data *tar_obj)
{
    if (DEBUG > 1)
        log_info("called %s with %d, %s, %s, %d, %s, %s", __PRETTY_FUNCTION__, level, SAFE_NAME(ch), VNULL(arg), type,
...
void cast_flying(int level, struct char_data *ch, const char *arg, int type, struct char_data *victim,
                 struct obj_data *tar_obj)
{
    if (DEBUG > 1)
        log_info("called %s with %d, %s, %s, %d, %s, %s", __PRETTY_FUNCTION__, level, SAFE_NAME(ch), VNULL(arg), type,
...
void cast_goodberry(int level, struct char_data *ch, const char *arg, int type, struct char_data *victim,
                    struct obj_data *tar_obj)
{
    if (DEBUG > 1)
        log_info("called %s with %d, %s, %s, %d, %s, %s", __PRETTY_FUNCTION__, level, SAFE_NAME(ch), VNULL(arg), type,
...
void cast_cure_critic(int level, struct char_data *ch, const char *arg, int type, struct char_data *victim,
                      struct obj_data *tar_obj)
{
    if (DEBUG > 1)
        log_info("called %s with %d, %s, %s, %d, %s, %s", __PRETTY_FUNCTION__, level, SAFE_NAME(ch), VNULL(arg), type,
...
void cast_cure_light(int level, struct char_data *ch, const char *arg, int type, struct char_data *victim,
                     struct obj_data *tar_obj)
{
    if (DEBUG > 1)
        log_info("called %s with %d, %s, %s, %d, %s, %s", __PRETTY_FUNCTION__, level, SAFE_NAME(ch), VNULL(arg), type,
...
void cast_cure_serious(int level, struct char_data *ch, const char *arg, int type, struct char_data *victim,
                       struct obj_data *tar_obj)
{
    if (DEBUG > 1)
        log_info("called %s with %d, %s, %s, %d, %s, %s", __PRETTY_FUNCTION__, level, SAFE_NAME(ch), VNULL(arg), type,
...
void cast_refresh(int level, struct char_data *ch, const char *arg, int type, struct char_data *victim,
                  struct obj_data *tar_obj)
{
    if (DEBUG > 1)
        log_info("called %s with %d, %s, %s, %d, %s, %s", __PRETTY_FUNCTION__, level, SAFE_NAME(ch), VNULL(arg), type,
...
void cast_second_wind(int level, struct char_data *ch, const char *arg, int type, struct char_data *victim,
                      struct obj_data *tar_obj)
{
    if (DEBUG > 1)
        log_info("called %s with %d, %s, %s, %d, %s, %s", __PRETTY_FUNCTION__, level, SAFE_NAME(ch), VNULL(arg), type,
...
void cast_shield(int level, struct char_data *ch, const char *arg, int type, struct char_data *victim,
                 struct obj_data *tar_obj)
{
    if (DEBUG > 1)
        log_info("called %s with %d, %s, %s, %d, %s, %s", __PRETTY_FUNCTION__, level, SAFE_NAME(ch), VNULL(arg), type,
...
void cast_curse(int level, struct char_data *ch, const char *arg, int type, struct char_data *victim,
                struct obj_data *tar_obj)
{
    if (DEBUG > 1)
        log_info("called %s with %d, %s, %s, %d, %s, %s", __PRETTY_FUNCTION__, level, SAFE_NAME(ch), VNULL(arg), type,
...
void cast_detect_evil(int level, struct char_data *ch, const char *arg, int type, struct char_data *victim,
                      struct obj_data *tar_obj)
{
    if (DEBUG > 1)
        log_info("called %s with %d, %s, %s, %d, %s, %s", __PRETTY_FUNCTION__, level, SAFE_NAME(ch), VNULL(arg), type,
...
void cast_detect_invisibility(int level, struct char_data *ch, const char *arg, int type, struct char_data *victim,
                              struct obj_data *tar_obj)
{
    if (DEBUG > 1)
        log_info("called %s with %d, %s, %s, %d, %s, %s", __PRETTY_FUNCTION__, level, SAFE_NAME(ch), VNULL(arg), type,
...
void cast_detect_magic(int level, struct char_data *ch, const char *arg, int type, struct char_data *victim,
                       struct obj_data *tar_obj)
{
    if (DEBUG > 1)
        log_info("called %s with %d, %s, %s, %d, %s, %s", __PRETTY_FUNCTION__, level, SAFE_NAME(ch), VNULL(arg), type,
...
void cast_detect_poison(int level, struct char_data *ch, const char *arg, int type, struct char_data *victim,
                        struct obj_data *tar_obj)
{
    if (DEBUG > 1)
        log_info("called %s with %d, %s, %s, %d, %s, %s", __PRETTY_FUNCTION__, level, SAFE_NAME(ch), VNULL(arg), type,
...
void cast_dispel_evil(int level, struct char_data *ch, const char *arg, int type, struct char_data *victim,
                      struct obj_data *tar_obj)
{
    if (DEBUG > 1)
        log_info("called %s with %d, %s, %s, %d, %s, %s", __PRETTY_FUNCTION__, level, SAFE_NAME(ch), VNULL(arg), type,
...
void cast_dispel_good(int level, struct char_data *ch, const char *arg, int type, struct char_data *victim,
                      struct obj_data *tar_obj)
{
    if (DEBUG > 1)
        log_info("called %s with %d, %s, %s, %d, %s, %s", __PRETTY_FUNCTION__, level, SAFE_NAME(ch), VNULL(arg), type,
...
void cast_faerie_fire(int level, struct char_data *ch, const char *arg, int type, struct char_data *victim,
                      struct obj_data *tar_obj)
{
    if (DEBUG > 1)
        log_info("called %s with %d, %s, %s, %d, %s, %s", __PRETTY_FUNCTION__, level, SAFE_NAME(ch), VNULL(arg), type,
...
void cast_enchant_weapon(int level, struct char_data *ch, const char *arg, int type, struct char_data *victim,
                         struct obj_data *tar_obj)
{
    if (DEBUG > 1)
        log_info("called %s with %d, %s, %s, %d, %s, %s", __PRETTY_FUNCTION__, level, SAFE_NAME(ch), VNULL(arg), type,
...
void cast_enchant_armor(int level, struct char_data *ch, const char *arg, int type, struct char_data *victim,
                        struct obj_data *tar_obj)
{
    if (DEBUG > 1)
        log_info("called %s with %d, %s, %s, %d, %s, %s", __PRETTY_FUNCTION__, level, SAFE_NAME(ch), VNULL(arg), type,
...
void cast_heal(int level, struct char_data *ch, const char *arg, int type, struct char_data *victim,
               struct obj_data *tar_obj)
{
    if (DEBUG > 1)
        log_info("called %s with %d, %s, %s, %d, %s, %s", __PRETTY_FUNCTION__, level, SAFE_NAME(ch), VNULL(arg), type,
...
void cast_invisibility(int level, struct char_data *ch, const char *arg, int type, struct char_data *victim,
                       struct obj_data *tar_obj)
{
    if (DEBUG > 1)
        log_info("called %s with %d, %s, %s, %d, %s, %s", __PRETTY_FUNCTION__, level, SAFE_NAME(ch), VNULL(arg), type,
...
void cast_locate_object(int level, struct char_data *ch, const char *arg, int type, struct char_data *victim,
                        struct obj_data *tar_obj)
{
    if (DEBUG > 1)
        log_info("called %s with %d, %s, %s, %d, %s, %s", __PRETTY_FUNCTION__, level, SAFE_NAME(ch), VNULL(arg), type,
...
void cast_poison(int level, struct char_data *ch, const char *arg, int type, struct char_data *victim,
                 struct obj_data *tar_obj)
{
    if (DEBUG > 1)
        log_info("called %s with %d, %s, %s, %d, %s, %s", __PRETTY_FUNCTION__, level, SAFE_NAME(ch), VNULL(arg), type,
...
void cast_protection_from_evil(int level, struct char_data *ch, const char *arg, int type, struct char_data *victim,
                               struct obj_data *tar_obj)
{
    if (DEBUG > 1)
        log_info("called %s with %d, %s, %s, %d, %s, %s", __PRETTY_FUNCTION__, level, SAFE_NAME(ch), VNULL(arg), type,
...
void cast_remove_curse(int level, struct char_data *ch, const char *arg, int type, struct char_data *victim,
                       struct obj_data *tar_obj)
{
    if (DEBUG > 1)
        log_info("called %s with %d, %s, %s, %d, %s, %s", __PRETTY_FUNCTION__, level, SAFE_NAME(ch), VNULL(arg), type,
...
void cast_remove_poison(int level, struct char_data *ch, const char *arg, int type, struct char_data *victim,
                        struct obj_data *tar_obj)
{
    if (DEBUG > 1)
        log_info("called %s with %d, %s, %s, %d, %s, %s", __PRETTY_FUNCTION__, level, SAFE_NAME(ch), VNULL(arg), type,
...
void cast_remove_paralysis(int level, struct char_data *ch, const char *arg, int type, struct char_data *victim,
                           struct obj_data *tar_obj)
{
    if (DEBUG > 1)
        log_info("called %s with %d, %s, %s, %d, %s, %s", __PRETTY_FUNCTION__, level, SAFE_NAME(ch), VNULL(arg), type,
...
void cast_sanctuary(int level, struct char_data *ch, const char *arg, int type, struct char_data *victim,
                    struct obj_data *tar_obj)
{
    if (DEBUG > 1)
        log_info("called %s with %d, %s, %s, %d, %s, %s", __PRETTY_FUNCTION__, level, SAFE_NAME(ch), VNULL(arg), type,
...
void cast_fireshield(int level, struct char_data *ch, const char *arg, int type, struct char_data *victim,
                     struct obj_data *tar_obj)
{
    if (DEBUG > 1)
        log_info("called %s with %d, %s, %s, %d, %s, %s", __PRETTY_FUNCTION__, level, SAFE_NAME(ch), VNULL(arg), type,
...
void cast_sleep(int level, struct char_data *ch, const char *arg, int type, struct char_data *victim,
                struct obj_data *tar_obj)
{
    if (DEBUG > 1)
        log_info("called %s with %d, %s, %s, %d, %s, %s", __PRETTY_FUNCTION__, level, SAFE_NAME(ch), VNULL(arg), type,
...
void cast_strength(int level, struct char_data *ch, const char *arg, int type, struct char_data *victim,
                   struct obj_data *tar_obj)
{
    if (DEBUG > 1)
        log_info("called %s with %d, %s, %s, %d, %s, %s", __PRETTY_FUNCTION__, level, SAFE_NAME(ch), VNULL(arg), type,
...
void cast_ventriloquate(int level, struct char_data *ch, const char *arg, int type, struct char_data *victim,
                        struct obj_data *tar_obj)
{
...
void cast_word_of_recall(int level, struct char_data *ch, const char *arg, int type, struct char_data *victim,
                         struct obj_data *tar_obj)
{
    if (DEBUG > 1)
        log_info("called %s with %d, %s, %s, %d, %s, %s", __PRETTY_FUNCTION__, level, SAFE_NAME(ch), VNULL(arg), type,
...
void cast_summon(int level, struct char_data *ch, const char *arg, int type, struct char_data *victim,
                 struct obj_data *tar_obj)
{
    if (DEBUG > 1)
        log_info("called %s with %d, %s, %s, %d, %s, %s", __PRETTY_FUNCTION__, level, SAFE_NAME(ch), VNULL(arg), type,
...
void cast_charm_monster(int level, struct char_data *ch, const char *arg, int type, struct char_data *victim,
                        struct obj_data *tar_obj)
{
    if (DEBUG > 1)
        log_info("called %s with %d, %s, %s, %d, %s, %s", __PRETTY_FUNCTION__, level, SAFE_NAME(ch), VNULL(arg), type,
...
void cast_sense_life(int level, struct char_data *ch, const char *arg, int type, struct char_data *victim,
                     struct obj_data *tar_obj)
{
    if (DEBUG > 1)
        log_info("called %s with %d, %s, %s, %d, %s, %s", __PRETTY_FUNCTION__, level, SAFE_NAME(ch), VNULL(arg), type,
...
void cast_identify(int level, struct char_data *ch, const char *arg, int type, struct char_data *victim,
                   struct obj_data *tar_obj)
{
    if (DEBUG > 1)
        log_info("called %s with %d, %s, %s, %d, %s, %s", __PRETTY_FUNCTION__, level, SAFE_NAME(ch), VNULL(arg), type,
...
void cast_dragon_breath(int level, struct char_data *ch, const char *arg, int type, struct char_data *victim,
                        struct obj_data *tar_obj)
{
...
void cast_fire_breath(int level, struct char_data *ch, const char *arg, int type, struct char_data *victim,
                      struct obj_data *tar_obj)
{
    if (DEBUG > 1)
        log_info("called %s with %d, %s, %s, %d, %s, %s", __PRETTY_FUNCTION__, level, SAFE_NAME(ch), VNULL(arg), type,
...
void cast_frost_breath(int level, struct char_data *ch, const char *arg, int type, struct char_data *victim,
                       struct obj_data *tar_obj)
{
    if (DEBUG > 1)
        log_info("called %s with %d, %s, %s, %d, %s, %s", __PRETTY_FUNCTION__, level, SAFE_NAME(ch), VNULL(arg), type,
...
void cast_acid_breath(int level, struct char_data *ch, const char *arg, int type, struct char_data *victim,
                      struct obj_data *tar_obj)
{
    if (DEBUG > 1)
        log_info("called %s with %d, %s, %s, %d, %s, %s", __PRETTY_FUNCTION__, level, SAFE_NAME(ch), VNULL(arg), type,
...
void cast_gas_breath(int level, struct char_data *ch, const char *arg, int type, struct char_data *victim,
                     struct obj_data *tar_obj)
{
    if (DEBUG > 1)
        log_info("called %s with %d, %s, %s, %d, %s, %s", __PRETTY_FUNCTION__, level, SAFE_NAME(ch), VNULL(arg), type,
...
void cast_lightning_breath(int level, struct char_data *ch, const char *arg, int type, struct char_data *victim,
                           struct obj_data *tar_obj)
{
    if (DEBUG > 1)
        log_info("called %s with %d, %s, %s, %d, %s, %s", __PRETTY_FUNCTION__, level, SAFE_NAME(ch), VNULL(arg), type,
...
void cast_knock(int level, struct char_data *ch, const char *arg, int type, struct char_data *victim,
                struct obj_data *tar_obj)
{
    int door = 0;
    int other_room = 0;
...
void cast_know_alignment(int level, struct char_data *ch, const char *arg, int type, struct char_data *victim,
                         struct obj_data *tar_obj)
{
    if (DEBUG > 1)
        log_info("called %s with %d, %s, %s, %d, %s, %s", __PRETTY_FUNCTION__, level, SAFE_NAME(ch), VNULL(arg), type,
...
void cast_weakness(int level, struct char_data *ch, const char *arg, int type, struct char_data *victim,
                   struct obj_data *tar_obj)
{
    if (DEBUG > 1)
        log_info("called %s with %d, %s, %s, %d, %s, %s", __PRETTY_FUNCTION__, level, SAFE_NAME(ch), VNULL(arg), type,
...
void cast_dispel_magic(int level, struct char_data *ch, const char *arg, int type, struct char_data *victim,
                       struct obj_data *tar_obj)
{
    if (DEBUG > 1)
        log_info("called %s with %d, %s, %s, %d, %s, %s", __PRETTY_FUNCTION__, level, SAFE_NAME(ch), VNULL(arg), type,
...
void cast_animate_dead(int level, struct char_data *ch, const char *arg, int type, struct char_data *victim,
                       struct obj_data *tar_obj)
{
...
void cast_succor(int level, struct char_data *ch, const char *arg, int type, struct char_data *victim,
                 struct obj_data *tar_obj)
{
    if (DEBUG > 1)
        log_info("called %s with %d, %s, %s, %d, %s, %s", __PRETTY_FUNCTION__, level, SAFE_NAME(ch), VNULL(arg), type,
...
void cast_paralyze(int level, struct char_data *ch, const char *arg, int type, struct char_data *victim,
                   struct obj_data *tar_obj)
{
    if (DEBUG > 1)
        log_info("called %s with %d, %s, %s, %d, %s, %s", __PRETTY_FUNCTION__, level, SAFE_NAME(ch), VNULL(arg), type,
...
void cast_fear(int level, struct char_data *ch, const char *arg, int type, struct char_data *victim,
               struct obj_data *tar_obj)
{
    if (DEBUG > 1)
        log_info("called %s with %d, %s, %s, %d, %s, %s", __PRETTY_FUNCTION__, level, SAFE_NAME(ch), VNULL(arg), type,
...
void cast_turn(int level, struct char_data *ch, const char *arg, int type, struct char_data *victim,
               struct obj_data *tar_obj)
{
    if (DEBUG > 1)
        log_info("called %s with %d, %s, %s, %d, %s, %s", __PRETTY_FUNCTION__, level, SAFE_NAME(ch), VNULL(arg), type,
...
void cast_poly_self(int level, struct char_data *ch, const char *arg, int type, struct char_data *victim,
                    struct obj_data *tar_obj)
{
...
void cast_shelter(int level, struct char_data *ch, const char *arg, int type, struct char_data *victim,
                  struct obj_data *tar_obj)
{
    struct obj_data *sac = NULL;
...
void cast_minor_creation(int level, struct char_data *ch, const char *arg, int type, struct char_data *victim,
                         struct obj_data *tar_obj)
{
    char buffer[40] = "\0\0\0\0\0\0\0";
    int obj = 0;
...
void cast_conjure_elemental(int level, struct char_data *ch, const char *arg, int type, struct char_data *victim,
                            struct obj_data *tar_obj)
{
    char buffer[40] = "\0\0\0\0\0\0\0";
    int mob = 0;
...
void cast_cacaodemon(int level, struct char_data *ch, const char *arg, int type, struct char_data *victim,
                     struct obj_data *tar_obj)
{
    char buffer[40] = "\0\0\0\0\0\0\0";
    int mob = 0;
...
void cast_mon_sum1(int level, struct char_data *ch, const char *arg, int type, struct char_data *victim,
                   struct obj_data *tar_obj)
{
    if (DEBUG > 1)
        log_info("called %s with %d, %s, %s, %d, %s, %s", __PRETTY_FUNCTION__, level, SAFE_NAME(ch), VNULL(arg), type,
...
void cast_mon_sum2(int level, struct char_data *ch, const char *arg, int type, struct char_data *victim,
                   struct obj_data *tar_obj)
{
    if (DEBUG > 1)
        log_info("called %s with %d, %s, %s, %d, %s, %s", __PRETTY_FUNCTION__, level, SAFE_NAME(ch), VNULL(arg), type,
...
void cast_mon_sum3(int level, struct char_data *ch, const char *arg, int type, struct char_data *victim,
                   struct obj_data *tar_obj)
{
    if (DEBUG > 1)
        log_info("called %s with %d, %s, %s, %d, %s, %s", __PRETTY_FUNCTION__, level, SAFE_NAME(ch), VNULL(arg), type,
...
void cast_mon_sum4(int level, struct char_data *ch, const char *arg, int type, struct char_data *victim,
                   struct obj_data *tar_obj)
{
    if (DEBUG > 1)
        log_info("called %s with %d, %s, %s, %d, %s, %s", __PRETTY_FUNCTION__, level, SAFE_NAME(ch), VNULL(arg), type,
...
void cast_mon_sum5(int level, struct char_data *ch, const char *arg, int type, struct char_data *victim,
                   struct obj_data *tar_obj)
{
    if (DEBUG > 1)
        log_info("called %s with %d, %s, %s, %d, %s, %s", __PRETTY_FUNCTION__, level, SAFE_NAME(ch), VNULL(arg), type,
...
void cast_mon_sum6(int level, struct char_data *ch, const char *arg, int type, struct char_data *victim,
                   struct obj_data *tar_obj)
{
    if (DEBUG > 1)
        log_info("called %s with %d, %s, %s, %d, %s, %s", __PRETTY_FUNCTION__, level, SAFE_NAME(ch), VNULL(arg), type,
...
void cast_mon_sum7(int level, struct char_data *ch, const char *arg, int type, struct char_data *victim,
                   struct obj_data *tar_obj)
{
    if (DEBUG > 1)
        log_info("called %s with %d, %s, %s, %d, %s, %s", __PRETTY_FUNCTION__, level, SAFE_NAME(ch), VNULL(arg), type,
...
void cast_fly_group(int level, struct char_data *ch, const char *arg, int type, struct char_data *victim,
                    struct obj_data *tar_obj)
{
    if (DEBUG > 1)
        log_info("called %s with %d, %s, %s, %d, %s, %s", __PRETTY_FUNCTION__, level, SAFE_NAME(ch), VNULL(arg), type,
...
void cast_aid(int level, struct char_data *ch, const char *arg, int type, struct char_data *victim,
              struct obj_data *tar_obj)
{
    if (DEBUG > 1)
        log_info("called %s with %d, %s, %s, %d, %s, %s", __PRETTY_FUNCTION__, level, SAFE_NAME(ch), VNULL(arg), type,
