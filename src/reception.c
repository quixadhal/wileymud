...
void 
add_obj_cost(struct char_data *ch, struct char_data *re,
...
bool 
recep_offer(struct char_data *ch, struct char_data *receptionist,
...
void 
update_file(FILE * fl, char *name, struct obj_file_u *st)
{
...
void 
obj_store_to_char(struct char_data *ch, struct obj_file_u *st)
{
  struct obj_data                 *obj;
  int                              i,
                                   j;
...
void 
load_char_objs(struct char_data *ch)
{
  FILE                            *fl;
  int                              i,
                                   j;
 ...
 */
void 
put_obj_in_store(struct obj_data *obj, struct obj_file_u *st)
{
  int                              i,
                                   j;
  bool                             found = FALSE;
...
static int 
contained_weight(struct obj_data *container)
{
  struct obj_data                 *tmp;
  int                              rval = 0;
 ...
 */
void 
obj_to_store(struct obj_data *obj, struct obj_file_u *st, struct char_data *ch, int delete)
{
  static char                      buf[240];
 ...
 */
void 
save_obj(struct char_data *ch, struct obj_cost *cost, int delete)
{
...
int 
receptionist(struct char_data *ch, int cmd, char *arg)
{
  char                             buf[240];
  struct obj_cost                  cost;
