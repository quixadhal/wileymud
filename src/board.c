...
struct Board {
  ...
  FILE                            *file;	/*
						 ...
						 */
  int                              Rnum;	/*
						 * Real # of object that this board hooks to 
						 */
  struct Board                    *next;
};
...
void 
InitABoard(struct obj_data *obj)
{
  extern struct Board             *board_list;
  struct Board                    *new,
                                  *tmp;
...
void 
board_write_msg(struct char_data *ch, char *arg, struct Board *b)
{
  char                             new_arg[60];
  char                            *ptr,
                                   time_str[60];
...
int 
board_remove_msg(struct char_data *ch, char *arg, struct Board *b)
{
  int                              ind,
                                   msg;
  char                             buf[256],
...
void 
board_save_board(struct Board *b)
{
  int                              ind,
                                   len;
...
void 
board_load_board(struct Board *b)
{
  int                              ind,
                                   len = 0;
...
void 
board_reset_board(struct Board *b)
{
  int                              ind;
...
{				/*
  ...
  if (DEBUG)
    dlog("error_log");
  fputs("Board : ", stderr);	/*
				 * more competent than the current but  
				 */
  fputs(str, stderr);		/*
				 * I got the advice to cut it out..;)   
				 */
  return;
}

int 
board_display_msg(struct char_data *ch, char *arg, struct Board *b)
{
  char                             buf[512],
                                   number[MAX_INPUT_LENGTH],
...
void 
board_fix_long_desc(struct Board *b)
{
  if (DEBUG)
...
int 
board_show_board(struct char_data *ch, char *arg, struct Board *b)
{
  int                              i;
