...
void 
show_mult_obj_to_char(struct obj_data *object, struct char_data *ch, int mode, int num)
{
  char                             buffer[MAX_STRING_LENGTH] = "\0";
  char                             tmp[10] = "\0";
...
void 
list_obj_in_room(struct obj_data *list, struct char_data *ch)
{
...
void 
list_obj_on_char(struct obj_data *list, struct char_data *ch)
{
  struct obj_data                 *i,
                                  *cond_ptr[50];
  int                              k,
...
void 
show_mult_char_to_char(struct char_data *i, struct char_data *ch, int mode, int num)
{
  char                             buffer[MAX_STRING_LENGTH];
  char                             tmp[10];
  int                              j,
...
void 
list_char_in_room(struct char_data *list, struct char_data *ch)
{
  struct char_data                *i,
                                  *cond_ptr[50];
  int                              k,
...
void 
do_search(struct char_data *ch, char *argument, int cmd)
{
  int                              door;
  char                             buf[256];
  char                            *exits[] =
...
void 
do_mystat(struct char_data *ch, char *argument, int cmd)
{
  char                             buf[256];
...
void 
do_info(struct char_data *ch, char *argument, int cmd)
{
  if (DEBUG)
    dlog("do_info");
...
void 
do_wizlist(struct char_data *ch, char *argument, int cmd)
{
  if (DEBUG)
    dlog("do_wizlist");
...
static int 
which_number_mobile(struct char_data *ch, struct char_data *mob)
{
  struct char_data                *i;
  char                            *name;
  int                              number;
...
char                            *
numbered_person(struct char_data *ch, struct char_data *person)
{
...
static void 
do_where_person(struct char_data *ch, struct char_data *person, struct string_block *sb)
{
  char                             buf[MAX_STRING_LENGTH];
...
static void 
do_where_object(struct char_data *ch, struct obj_data *obj,
...
void 
do_world(struct char_data *ch, char *argument, int cmd)
{
  static char                      buf[100];
  long                             ct,
                                   ot;
