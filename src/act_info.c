...
void do_score(struct char_data *ch, char *argument, int cmd)
{
  ...
  cprintf(ch, "%s%s %s %s is %d years old.\n\r",
    ((age(ch).month == 0) && (age(ch).day == 0)) ? "Newbie " : "",
    GET_PRETITLE(ch) ? GET_PRETITLE(ch) : "", GET_NAME(ch), GET_TITLE(ch),
    GET_AGE(ch));
  ...
  if(GetMaxLevel(ch) > 3)
  {
    ...
    if(GET_ADD(ch) > 99)
      cprintf(ch,
        ...
        GET_STR(ch), GET_DEX(ch), GET_CON(ch), GET_INT(ch), GET_WIS(ch));
    else
      cprintf(ch,
  ...
  if(MOUNTED(ch)) {
    if((GET_LEVEL(ch, RANGER_LEVEL_IND) > 0) ||
       IS_AFFECTED(MOUNTED(ch), AFF_CHARM)) {
      cprintf(ch, "Your %s has %d/%d Hit Points, and %d/%d Movement.\n\r",
        GET_NAME(MOUNTED(ch)),
        GET_HIT(MOUNTED(ch)),GET_MAX_HIT(MOUNTED(ch)),
        GET_MOVE(MOUNTED(ch)),GET_MAX_MOVE(MOUNTED(ch)));
    }
  ...
  if (!IS_IMMORTAL(ch) && (!IS_NPC(ch))) {
    strcpy(buf, "You are ");
    if(GET_COND(ch, DRUNK) > 10) {
      strcat(buf, " intoxicated");
      isneedy= 1;
    }
    if(GET_COND(ch, FULL) < 2) {
      if(isneedy) strcat(buf, ",");
      strcat(buf, " hungry");
      isneedy= 1;
    }
    if(GET_COND(ch,THIRST) < 2) {
      if(isneedy) strcat(buf, ", and");
      strcat(buf, " thirsty.\n\r");
      isneedy= 1;
    }
    if(isneedy) cprintf(ch, buf);
  }
  ...
  sprintf(buf,
    "      +------------------------------+------------------------------+\n\r");
  algn= MAX(-1000, MIN(GET_ALIGNMENT(ch), 1000)) / 32;
  buf[37 + algn]= '*';
  cprintf(ch, buf);
  sprintf(buf,
    "                                                                     \n\r");
  ...
  cprintf(ch,
    ...
    GET_EXP(ch), playing_time.day, playing_time.hours);
  
  if(GET_LEVEL(ch,MAGE_LEVEL_IND) > 0) {
    cprintf(ch, 
      "As a %d%s level mage, you need %d more xp to become ",
      GET_LEVEL(ch, MAGE_LEVEL_IND), ordinal(GET_LEVEL(ch, MAGE_LEVEL_IND)),
      titles[MAGE_LEVEL_IND][GET_LEVEL(ch,MAGE_LEVEL_IND)+1].exp- GET_EXP(ch));
    switch(GET_SEX(ch)) {
      case SEX_MALE:
        tmpstr= titles[MAGE_LEVEL_IND][GET_LEVEL(ch,MAGE_LEVEL_IND)+1].title_m;
        break;
      case SEX_FEMALE:
        tmpstr= titles[MAGE_LEVEL_IND][GET_LEVEL(ch,MAGE_LEVEL_IND)+1].title_f;
        break;
      default:
        tmpstr= "bug";
        break;
  ...
  if(GET_LEVEL(ch,CLERIC_LEVEL_IND) > 0) {
    cprintf(ch,
      "As a %d%s level cleric, you need %d more xp to become ",
      GET_LEVEL(ch, CLERIC_LEVEL_IND), ordinal(GET_LEVEL(ch, CLERIC_LEVEL_IND)),
      titles[CLERIC_LEVEL_IND][GET_LEVEL(ch,CLERIC_LEVEL_IND)+1].exp- GET_EXP(ch));
    switch(GET_SEX(ch)) {
      case SEX_MALE:
        tmpstr= titles[CLERIC_LEVEL_IND][GET_LEVEL(ch,CLERIC_LEVEL_IND)+1].title_m;
        break;
      case SEX_FEMALE:
        tmpstr= titles[CLERIC_LEVEL_IND][GET_LEVEL(ch,CLERIC_LEVEL_IND)+1].title_f;
        break;
      default:
        tmpstr= "bug";
        break;
  ...
  if(GET_LEVEL(ch,WARRIOR_LEVEL_IND) > 0) {
    cprintf(ch,
      "As a %d%s level warrior, you need %d more xp to become ",
      GET_LEVEL(ch, WARRIOR_LEVEL_IND), ordinal(GET_LEVEL(ch, WARRIOR_LEVEL_IND)),
      titles[WARRIOR_LEVEL_IND][GET_LEVEL(ch,WARRIOR_LEVEL_IND)+1].exp- GET_EXP(ch));
    switch(GET_SEX(ch)) {
      case SEX_MALE:
        tmpstr= titles[WARRIOR_LEVEL_IND][GET_LEVEL(ch,WARRIOR_LEVEL_IND)+1].title_m;
        break;
      case SEX_FEMALE:
        tmpstr= titles[WARRIOR_LEVEL_IND][GET_LEVEL(ch,WARRIOR_LEVEL_IND)+1].title_f;
        break;
      default:
        tmpstr= "bug";
        break;
  ...
  if(GET_LEVEL(ch,THIEF_LEVEL_IND) > 0) {
    cprintf(ch,
      "As a %d%s level thief, you need %d more xp to become ",
      GET_LEVEL(ch, THIEF_LEVEL_IND), ordinal(GET_LEVEL(ch, THIEF_LEVEL_IND)),
      titles[THIEF_LEVEL_IND][GET_LEVEL(ch,THIEF_LEVEL_IND)+1].exp- GET_EXP(ch));
    switch(GET_SEX(ch)) {
      case SEX_MALE:
        tmpstr= titles[THIEF_LEVEL_IND][GET_LEVEL(ch,THIEF_LEVEL_IND)+1].title_m;
        break;
      case SEX_FEMALE:
        tmpstr= titles[THIEF_LEVEL_IND][GET_LEVEL(ch,THIEF_LEVEL_IND)+1].title_f;
        break;
      default:
        tmpstr= "bug";
        break;
  ...
  if(GET_LEVEL(ch,RANGER_LEVEL_IND) > 0) {
    cprintf(ch,
      "As a %d%s level ranger, you need %d more xp to become ",
      GET_LEVEL(ch, RANGER_LEVEL_IND), ordinal(GET_LEVEL(ch, RANGER_LEVEL_IND)),
      titles[RANGER_LEVEL_IND][GET_LEVEL(ch,RANGER_LEVEL_IND)+1].exp- GET_EXP(ch));
    switch(GET_SEX(ch)) {
      case SEX_MALE:
        tmpstr= titles[RANGER_LEVEL_IND][GET_LEVEL(ch,RANGER_LEVEL_IND)+1].title_m;
        break;
      case SEX_FEMALE:
        tmpstr= titles[RANGER_LEVEL_IND][GET_LEVEL(ch,RANGER_LEVEL_IND)+1].title_f;
        break;
      default:
        tmpstr= "bug";
        break;
  ...
  if(GET_LEVEL(ch,DRUID_LEVEL_IND) > 0) {
    cprintf(ch, 
      "As a %d%s level druid, you need %d more xp to become ",
      GET_LEVEL(ch, DRUID_LEVEL_IND), ordinal(GET_LEVEL(ch, DRUID_LEVEL_IND)),
      titles[DRUID_LEVEL_IND][GET_LEVEL(ch,DRUID_LEVEL_IND)+1].exp- GET_EXP(ch));
    switch(GET_SEX(ch)) {
      case SEX_MALE:
        tmpstr= titles[DRUID_LEVEL_IND][GET_LEVEL(ch,DRUID_LEVEL_IND)+1].title_m;
        break;
      case SEX_FEMALE:
        tmpstr= titles[DRUID_LEVEL_IND][GET_LEVEL(ch,DRUID_LEVEL_IND)+1].title_f;
        break;
      default:
        tmpstr= "bug";
        break;
