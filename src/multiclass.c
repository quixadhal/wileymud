...
int 
GetClassLevel(struct char_data *ch, int class)
{
...
int 
OnlyClass(struct char_data *ch, int class)
{
  int                              i;
...
int 
HasClass(struct char_data *ch, int class)
{
...
int 
HowManyClasses(struct char_data *ch)
{
  short                            tot = 0;
...
int 
BestFightingClass(struct char_data *ch)
{
...
int 
BestThiefClass(struct char_data *ch)
{
  if (GET_LEVEL(ch, THIEF_LEVEL_IND))
    return (THIEF_LEVEL_IND);
  if (GET_LEVEL(ch, RANGER_LEVEL_IND))
...
int 
BestMagicClass(struct char_data *ch)
{
...
int 
GetSecMaxLev(struct char_data *ch)
{
  return (GetALevel(ch, 2));
}

int 
GetALevel(struct char_data *ch, int which)
{
  byte                             ind[6],
                                   j,
                                   k,
...
int 
GetThirdMaxLev(struct char_data *ch)
{
  return (GetALevel(ch, 3));
}

int 
GetMaxLevel(struct char_data *ch)
{
  byte                             max = 0,
                                   i;
...
int 
GetTotLevel(struct char_data *ch)
{
...
void 
StartLevels(struct char_data *ch)
{
