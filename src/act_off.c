...
void 
do_swat(struct char_data *ch, char *argument, int cmd)
{
...
void 
do_bandage(struct char_data *ch, char *argument, int cmd)
{
  struct char_data                *victim;
  char                             name[256];
  byte                             percent;
...
void 
slam_into_wall(struct char_data *ch, struct room_direction_data *exitp)
{
  char                             doorname[128];
  char                             buf[256];
...
void 
do_doorbash(struct char_data *ch, char *arg, int cmd)
{
  extern char                     *dirs[];
  int                              dir;
  int                              ok;
...
void 
do_wimp(struct char_data *ch, char *argument, int cmd)
{
  /*
...
void 
do_breath(struct char_data *ch, char *argument, int cmd)
{
  struct char_data                *victim;
